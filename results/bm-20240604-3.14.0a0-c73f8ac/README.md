...
- [📈time plot](bm-20240604-linux-x86_64-Fidget%252dSpinner-stackref_all-3.14.0a0-c73f8ac-vs-3.10.4.png)

### vs. 3.11.0

- Geometric mean: 1.06x faster (HPT: reliability of 90.34%, 1.00x faster at 99th %ile)
- Memory usage: 1.04x
- missing benchmarks: aiohttp, chameleon, djangocms, flaskblogging, gunicorn, mypy2, sqlalchemy_declarative, sqlalchemy_imperative, unpack_sequence
- [📄table](bm-20240604-linux-x86_64-Fidget%252dSpinner-stackref_all-3.14.0a0-c73f8ac-vs-3.11.0.md)
- [📈time plot](bm-20240604-linux-x86_64-Fidget%252dSpinner-stackref_all-3.14.0a0-c73f8ac-vs-3.11.0.png)
...
- [📈time plot](bm-20240604-linux-x86_64-Fidget%252dSpinner-stackref_all-3.14.0a0-c73f8ac-vs-3.12.0.png)

### vs. base

- Geometric mean: 1.02x slower (HPT: reliability of 100.00%, 1.00x slower at 99th %ile)
- Memory usage: 1.00x
- [🧠memory plot](bm-20240604-linux-x86_64-Fidget%252dSpinner-stackref_all-3.14.0a0-c73f8ac-vs-base-mem.png)
- [📄table](bm-20240604-linux-x86_64-Fidget%252dSpinner-stackref_all-3.14.0a0-c73f8ac-vs-base.md)
- [📈time plot](bm-20240604-linux-x86_64-Fidget%252dSpinner-stackref_all-3.14.0a0-c73f8ac-vs-base.png)
...
- [📈time plot](bm-20240604-pythonperf2-x86_64-Fidget%252dSpinner-stackref_all-3.14.0a0-c73f8ac-vs-3.10.4.png)
...
- Memory usage: 1.14x
- missing benchmarks: aiohttp, chameleon, flaskblogging, gunicorn, mypy2, sqlalchemy_declarative, sqlalchemy_imperative, unpack_sequence
- [📄table](bm-20240604-pythonperf2-x86_64-Fidget%252dSpinner-stackref_all-3.14.0a0-c73f8ac-vs-3.11.0.md)
- [📈time plot](bm-20240604-pythonperf2-x86_64-Fidget%252dSpinner-stackref_all-3.14.0a0-c73f8ac-vs-3.11.0.png)
...
- [📈time plot](bm-20240604-pythonperf2-x86_64-Fidget%252dSpinner-stackref_all-3.14.0a0-c73f8ac-vs-3.12.0.png)

### vs. base

- Geometric mean: 1.01x slower (HPT: reliability of 99.99%, 1.00x slower at 99th %ile)
- Memory usage: 1.00x
- [🧠memory plot](bm-20240604-pythonperf2-x86_64-Fidget%252dSpinner-stackref_all-3.14.0a0-c73f8ac-vs-base-mem.png)
- [📄table](bm-20240604-pythonperf2-x86_64-Fidget%252dSpinner-stackref_all-3.14.0a0-c73f8ac-vs-base.md)
- [📈time plot](bm-20240604-pythonperf2-x86_64-Fidget%252dSpinner-stackref_all-3.14.0a0-c73f8ac-vs-base.png)
