...
|---|---:|---:|---:|---:|
| LOAD_FAST | 448,576,120 | 20.3% | 20.3% |  |
| LOAD_ATTR_INSTANCE_VALUE | 129,913,011 | 5.9% | 26.2% |  |
| POP_JUMP_IF_FALSE | 123,603,579 | 5.6% | 31.8% |  |
...
| RETURN_VALUE | 69,027,178 | 3.1% | 64.1% |  |
...
| CALL_METHOD_DESCRIPTOR_O | 27,992,889 | 1.3% | 86.9% | 0.0% |
| TO_BOOL_NONE | 25,751,560 | 1.2% | 88.1% | 0.0% |
| LOAD_ATTR_MODULE | 24,628,958 | 1.1% | 89.2% |  |
| COMPARE_OP_INT | 20,234,838 | 0.9% | 90.1% |  |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 90,203,994 | 4.1% | 9.8% |
| RESUME_CHECK LOAD_FAST | 89,570,078 | 4.1% | 13.8% |
...
| POP_TOP LOAD_FAST | 39,936,558 | 1.8% | 32.7% |
...
| LOAD_ATTR_METHOD_WITH_VALUES CALL_PY_EXACT_ARGS | 31,348,029 | 1.4% | 41.7% |
...
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 26,875,929 | 1.2% | 46.9% |
| RETURN_CONST POP_TOP | 26,872,658 | 1.2% | 48.2% |
| TO_BOOL_NONE POP_JUMP_IF_FALSE | 25,751,540 | 1.2% | 49.3% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 24,627,858 | 1.1% | 50.4% |
| LOAD_ATTR_MODULE PUSH_NULL | 24,255,998 | 1.1% | 51.5% |
| LOAD_FAST POP_JUMP_IF_NOT_NONE | 23,886,309 | 1.1% | 52.6% |
...
| RETURN_VALUE STORE_FAST | 19,035,209 | 0.9% | 60.1% |
...
| PUSH_NULL LOAD_FAST | 7,912,198 | 0.4% | 82.4% |
...
| PUSH_NULL CALL | 6,345,509 | 0.3% | 83.7% |
...
| TO_BOOL_LIST POP_JUMP_IF_FALSE | 5,229,567 | 0.2% | 85.8% |
...
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 4,833,809 | 0.2% | 88.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 65,294,176 | 52.8% |
| TO_BOOL_NONE | 25,751,540 | 20.8% |
| COMPARE_OP_INT | 20,234,838 | 16.4% |
| TO_BOOL | 6,719,500 | 5.4% |
| TO_BOOL_LIST | 5,229,567 | 4.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 90,203,994 | 73.0% |
| RETURN_CONST | 16,047,360 | 13.0% |
| LOAD_CONST | 10,827,158 | 8.8% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 36,952,729 | 22.3% |
|          hit | 128,463,628 | 77.6% |
|         miss | 761,180 | 0.5% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 11,201,969 | 9.9% |
|          hit | 102,246,632 | 90.1% |
|         miss | 1,480 | 0.0% |
...
|---|---:|---:|
| Basic | 1,121,949,888 | 50.7% |
| Not specialized | 261,763,482 | 11.8% |
| Specialized hits | 821,064,483 | 37.1% |
| Specialized misses | 6,175,508 | 0.3% |
...
|Name | Count | Ratio | 
|---|---:|---:|
| CALL | 36,952,729 | 41.2% |
| LOAD_ATTR | 34,272,574 | 38.2% |
| TO_BOOL | 11,201,969 | 12.5% |
...
| Calls to Python functions inlined | 73,524,856 | 58.6% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 56,534,594 | 34.8% |
| Frees to freelist | 56,875,225 |  |
| Allocations | 105,708,796 | 65.2% |
| Allocations to 512 bytes | 104,900,074 | 64.7% |
| Allocations to 4 kbytes | 808,588 | 0.5% |
| Allocations over 4 kbytes | 134 | 0.0% |
| Frees | 105,623,709 |  |
| New values | 440 |  |
| Interpreter increfs | 1,290,239,106 | 79.4% |
| Interpreter decrefs | 1,360,835,770 | 77.0% |
| Increfs | 334,074,916 | 20.6% |
| Decrefs | 405,524,358 | 23.0% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 69,222,569 |  |
| Method cache misses | 4,296 |  |
| Method cache collisions | 3,981 |  |
| Method cache dunder hits | 16,402,095 |  |
...
|---:|---:|---:|---:|
| 0 | 55,349 | 2,040 | 378,879,648 |
| 1 | 5,020 | 0 | 392,361,954 |
| 2 | 451 | 0 | 1,013,276,870 |
...
| _CHECK_ATTR_MODULE | 371,831 | 0.0% | 99.7% |  |
| _LOAD_ATTR_MODULE | 371,831 | 0.0% | 99.8% |  |
| _STORE_ATTR_SLOT | 371,831 | 0.0% | 99.8% |  |
| _LOAD_CONST_INLINE | 371,831 | 0.0% | 99.9% |  |
| _CHECK_GLOBALS | 371,831 | 0.0% | 99.9% |  |
