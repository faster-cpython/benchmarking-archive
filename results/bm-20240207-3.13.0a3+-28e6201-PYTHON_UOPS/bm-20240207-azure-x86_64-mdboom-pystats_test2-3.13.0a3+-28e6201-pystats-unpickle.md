...
| Increfs | 460,479,822 | 98.9% |
| Decrefs | 641,478,936 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 4,071,971 |  |
| Method cache misses | 844,129 |  |
| Method cache collisions | 868,337 |  |
| Method cache dunder hits | 1,614,319 |  |
| Method cache dunder misses | 24,801 |  |
