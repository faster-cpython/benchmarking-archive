...
|---|---:|---:|---:|---:|
| LOAD_FAST | 98,772,856 | 20.8% | 20.8% |  |
| LOAD_CONST | 77,932,988 | 16.4% | 37.2% |  |
...
| LOAD_GLOBAL_MODULE | 20,005,300 | 4.2% | 90.5% |  |
| LOAD_GLOBAL | 19,485,580 | 4.1% | 94.6% |  |
| BINARY_OP_ADD_INT | 19,428,860 | 4.1% | 98.7% |  |
| STORE_FAST | 672,932 | 0.1% | 98.9% |  |
| POP_JUMP_IF_FALSE | 407,936 | 0.1% | 99.0% |  |
| LOAD_ATTR_MODULE | 387,164 | 0.1% | 99.0% | 3.2% |
...
| COMPARE_OP_STR | 29,052 | 0.0% | 99.9% | 0.1% |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_CONST | 77,746,212 | 16.4% | 16.4% |
...
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 309,840 | 0.1% | 98.3% |
| STORE_FAST LOAD_FAST | 272,600 | 0.1% | 98.3% |
...
| POP_JUMP_IF_FALSE LOAD_FAST | 152,192 | 0.0% | 98.7% |
| STORE_FAST LOAD_GLOBAL_MODULE | 149,872 | 0.0% | 98.8% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 149,000 | 0.0% | 98.8% |
...
| LOAD_FAST STORE_FAST | 108,832 | 0.0% | 98.9% |
...
| LOAD_ATTR_MODULE LOAD_FAST | 66,296 | 0.0% | 99.1% |
...
| FOR_ITER STORE_FAST | 50,172 | 0.0% | 99.3% |
...
| POP_JUMP_IF_FALSE ENTER_EXECUTOR | 20,040 | 0.0% | 99.5% |
| LOAD_CONST MAP_ADD | 19,720 | 0.0% | 99.6% |
| COMPARE_OP_STR POP_JUMP_IF_FALSE | 19,112 | 0.0% | 99.6% |
...
| STORE_FAST | 272,600 | 0.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_CONST | 77,746,212 | 78.7% |
...
| COMPARE_OP_STR | 19,112 | 4.7% |
| CONTAINS_OP | 16,184 | 4.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 152,192 | 37.3% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 309,840 | 80.0% |
...
|---|---:|---:|
| Basic | 295,697,188 | 62.2% |
| Not specialized | 20,595,525 | 4.3% |
| Specialized hits | 158,738,064 | 33.4% |
...
| Allocations | 79,822,800 | 99.1% |
| Allocations to 512 bytes | 79,810,640 | 99.1% |
| Allocations to 4 kbytes | 7,120 | 0.0% |
| Allocations over 4 kbytes | 5,040 | 0.0% |
| Frees | 79,800,910 |  |
| New values | 2,340 |  |
| Interpreter increfs | 82,926,992 | 15.0% |
| Interpreter decrefs | 122,732,540 | 23.8% |
| Increfs | 468,690,539 | 85.0% |
| Decrefs | 392,669,714 | 76.2% |
| Materialize dict (on request) | 240 | 10.3% |
| Materialize dict (new key) | 220 | 9.4% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 60 | 2.6% |
| Method cache hits | 38,952,267 |  |
| Method cache misses | 10,473 |  |
| Method cache collisions | 9,560 |  |
| Method cache dunder hits | 177,308 |  |
| Method cache dunder misses | 1,352 |  |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 2,157,760 | 24.4% | 24.4% |  |
| _SET_IP | 1,305,104 | 14.8% | 39.2% |  |
| _CHECK_VALIDITY | 1,244,532 | 14.1% | 53.3% |  |
| STORE_FAST | 833,928 | 9.4% | 62.7% |  |
| _GUARD_IS_FALSE_POP | 413,696 | 4.7% | 67.4% | 0.3% |
| _FOR_ITER_TIER_TWO | 375,060 | 4.2% | 71.7% | 12.4% |
| UNPACK_SEQUENCE_TWO_TUPLE | 329,036 | 3.7% | 75.4% |  |
| _JUMP_TO_TOP | 327,512 | 3.7% | 79.1% |  |
| CONTAINS_OP | 326,504 | 3.7% | 82.8% |  |
| STORE_SUBSCR_DICT | 322,900 | 3.7% | 86.4% |  |
| _GUARD_TYPE_VERSION | 103,768 | 1.2% | 87.6% |  |
| _GUARD_IS_TRUE_POP | 97,996 | 1.1% | 88.7% | 4.7% |
| TO_BOOL_STR | 88,800 | 1.0% | 89.7% |  |
| COMPARE_OP_STR | 85,448 | 1.0% | 90.7% |  |
| _EXIT_TRACE | 81,436 | 0.9% | 91.6% | 100.0% |
| _LOAD_ATTR_METHOD_NO_DICT | 79,428 | 0.9% | 92.5% |  |
| _CHECK_GLOBALS | 61,084 | 0.7% | 93.2% |  |
...
| _CHECK_BUILTINS | 15,040 | 0.2% | 97.6% |  |
