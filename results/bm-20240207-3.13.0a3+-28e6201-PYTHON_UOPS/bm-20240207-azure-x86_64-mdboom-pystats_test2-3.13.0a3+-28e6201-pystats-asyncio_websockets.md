...
|---|---:|---:|---:|---:|
| LOAD_FAST | 3,992,573 | 18.5% | 18.5% |  |
| POP_JUMP_IF_FALSE | 1,138,235 | 5.3% | 23.8% |  |
| LOAD_CONST | 1,135,755 | 5.3% | 29.1% |  |
| RESUME_CHECK | 863,865 | 4.0% | 33.1% | 0.0% |
| LOAD_FAST_LOAD_FAST | 816,884 | 3.8% | 36.9% |  |
| LOAD_ATTR_INSTANCE_VALUE | 776,960 | 3.6% | 40.5% | 0.1% |
...
| LOAD_GLOBAL_BUILTIN | 615,872 | 2.9% | 56.3% | 0.4% |
| POP_TOP | 565,774 | 2.6% | 58.9% |  |
| RETURN_VALUE | 519,848 | 2.4% | 61.3% |  |
| CALL_PY_EXACT_ARGS | 416,918 | 1.9% | 63.3% | 0.1% |
| RETURN_CONST | 384,162 | 1.8% | 65.1% |  |
| CALL | 359,606 | 1.7% | 66.7% |  |
...
| LOAD_ATTR_METHOD_NO_DICT | 236,287 | 1.1% | 75.7% | 0.4% |
...
| CALL_METHOD_DESCRIPTOR_NOARGS | 115,541 | 0.5% | 88.9% | 8.6% |
| JUMP_FORWARD | 106,925 | 0.5% | 89.4% |  |
| NOP | 99,764 | 0.5% | 89.9% |  |
...
| DELETE_SUBSCR | 33,916 | 0.2% | 96.5% |  |
| BUILD_SLICE | 33,656 | 0.2% | 96.6% |  |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 751,960 | 3.5% | 3.5% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 400,939 | 1.9% | 17.0% |
...
| LOAD_GLOBAL_BUILTIN LOAD_GLOBAL_BUILTIN | 105,116 | 0.5% | 50.4% |
| PUSH_NULL LOAD_FAST | 103,865 | 0.5% | 50.9% |
| STORE_ATTR_INSTANCE_VALUE LOAD_FAST_LOAD_FAST | 103,140 | 0.5% | 51.3% |
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 102,640 | 0.5% | 51.8% |
...
| CALL_LEN LOAD_FAST | 92,360 | 0.4% | 54.0% |
...
| LOAD_ATTR_INSTANCE_VALUE LOAD_ATTR_METHOD_NO_DICT | 81,644 | 0.4% | 55.7% |
...
| JUMP_FORWARD LOAD_FAST | 56,305 | 0.3% | 67.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| BUILD_SLICE | 33,596 | 99.1% |
| LOAD_FAST | 260 | 0.8% |
| CALL | 60 | 0.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 33,596 | 99.1% |
| LOAD_CONST | 140 | 0.4% |
...
| LOAD_GLOBAL_BUILTIN | 400,939 | 10.0% |
| LOAD_CONST | 213,294 | 5.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 751,960 | 18.8% |
...
| LOAD_GLOBAL_BUILTIN | 179,359 | 15.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 102,640 | 53.3% |
| LOAD_FAST | 72,716 | 37.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 92,360 | 47.9% |
| LOAD_CONST | 59,236 | 30.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_METHOD_NO_DICT | 50,084 | 43.3% |
...
| LOAD_FAST | 67,881 | 27.6% |
| LOAD_ATTR_INSTANCE_VALUE | 20,440 | 8.3% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 242,939 | 98.9% |
...
| CALL_LEN | 102,640 | 13.2% |
| LOAD_ATTR_METHOD_NO_DICT | 81,644 | 10.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 81,644 | 34.6% |
...
| CALL_METHOD_DESCRIPTOR_NOARGS | 50,084 | 21.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 179,359 | 29.1% |
| RESUME_CHECK | 146,800 | 23.8% |
| LOAD_GLOBAL_BUILTIN | 105,116 | 17.1% |
| LOAD_FAST | 48,320 | 7.8% |
| STORE_FAST | 43,798 | 7.1% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 400,939 | 65.1% |
| LOAD_GLOBAL_BUILTIN | 105,116 | 17.1% |
...
|---|---:|---:|
| Basic | 10,670,782 | 49.5% |
| Not specialized | 3,470,231 | 16.1% |
| Specialized hits | 7,325,074 | 34.0% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 776,557 | 32.6% |
| Frees to freelist | 780,720 |  |
| Allocations | 1,603,880 | 67.4% |
| Allocations to 512 bytes | 1,413,613 | 59.4% |
| Allocations to 4 kbytes | 132,435 | 5.6% |
| Allocations over 4 kbytes | 57,832 | 2.4% |
| Frees | 1,542,848 |  |
| New values | 34,900 |  |
| Interpreter increfs | 12,353,528 | 76.8% |
| Interpreter decrefs | 14,169,426 | 78.3% |
| Increfs | 3,731,816 | 23.2% |
| Decrefs | 3,921,194 | 21.7% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 1,224,669 |  |
| Method cache misses | 35,464 |  |
| Method cache collisions | 41,334 |  |
| Method cache dunder hits | 355,478 |  |
| Method cache dunder misses | 8,407 |  |
