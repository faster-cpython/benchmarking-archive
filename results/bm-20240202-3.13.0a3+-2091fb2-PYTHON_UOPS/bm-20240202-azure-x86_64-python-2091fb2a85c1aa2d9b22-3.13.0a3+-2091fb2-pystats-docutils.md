...
| STORE_FAST | 421,061,300 | 4.4% | 28.9% |  |
...
| POP_TOP | 279,812,500 | 3.0% | 46.6% |  |
| LOAD_GLOBAL_BUILTIN | 270,472,520 | 2.9% | 49.5% | 0.0% |
| LOAD_ATTR_METHOD_WITH_VALUES | 268,182,080 | 2.8% | 52.3% | 42.4% |
| CALL_PY_EXACT_ARGS | 250,451,280 | 2.6% | 55.0% | 4.9% |
| RETURN_CONST | 215,474,920 | 2.3% | 57.2% |  |
| ENTER_EXECUTOR | 211,117,900 | 2.2% | 59.5% |  |
| TO_BOOL_BOOL | 201,429,300 | 2.1% | 61.6% | 0.0% |
| RETURN_VALUE | 194,590,960 | 2.1% | 63.6% |  |
| LOAD_ATTR | 186,692,060 | 2.0% | 65.6% |  |
| NOP | 165,973,260 | 1.8% | 67.3% |  |
| GET_ITER | 163,392,540 | 1.7% | 69.1% |  |
| LOAD_ATTR_METHOD_NO_DICT | 157,805,660 | 1.7% | 70.7% | 0.1% |
| POP_JUMP_IF_TRUE | 152,995,980 | 1.6% | 72.3% |  |
| FOR_ITER_LIST | 125,404,080 | 1.3% | 73.7% | 17.5% |
| STORE_ATTR_INSTANCE_VALUE | 124,995,580 | 1.3% | 75.0% | 57.5% |
| LOAD_ATTR_WITH_HINT | 108,515,120 | 1.1% | 76.1% | 1.3% |
| CALL_ISINSTANCE | 106,065,440 | 1.1% | 77.3% |  |
...
| BINARY_SLICE | 26,457,960 | 0.3% | 94.1% |  |
...
| BINARY_SUBSCR_TUPLE_INT | 11,493,760 | 0.1% | 97.5% |  |
...
| NOP LOAD_FAST | 101,685,500 | 1.1% | 24.9% |
| LOAD_FAST LOAD_CONST | 101,438,400 | 1.1% | 26.0% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 95,117,960 | 1.0% | 27.0% |
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 93,849,560 | 1.0% | 28.0% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 91,040,080 | 1.0% | 29.0% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST_LOAD_FAST | 89,771,060 | 0.9% | 29.9% |
| LOAD_CONST LOAD_FAST | 86,322,540 | 0.9% | 30.8% |
| POP_TOP LOAD_FAST | 85,071,920 | 0.9% | 31.7% |
| LOAD_FAST LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES | 84,167,420 | 0.9% | 32.6% |
| POP_TOP ENTER_EXECUTOR | 80,736,620 | 0.9% | 33.5% |
| LOAD_FAST STORE_ATTR_INSTANCE_VALUE | 80,513,920 | 0.8% | 34.3% |
| GET_ITER FOR_ITER_LIST | 72,128,780 | 0.8% | 35.1% |
| LOAD_FAST LOAD_ATTR_WITH_HINT | 70,781,400 | 0.7% | 35.8% |
| LOAD_FAST LOAD_ATTR_SLOT | 68,110,820 | 0.7% | 36.5% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 64,570,420 | 0.7% | 37.2% |
| STORE_ATTR_INSTANCE_VALUE LOAD_FAST | 62,667,760 | 0.7% | 37.9% |
| STORE_FAST LOAD_GLOBAL_BUILTIN | 61,910,980 | 0.7% | 38.5% |
| POP_JUMP_IF_TRUE ENTER_EXECUTOR | 61,882,840 | 0.7% | 39.2% |
...
| POP_JUMP_IF_NOT_NONE LOAD_FAST | 52,167,800 | 0.6% | 43.4% |
| FOR_ITER_LIST STORE_FAST | 51,615,560 | 0.5% | 43.9% |
...
| LOAD_CONST LOAD_CONST | 33,948,220 | 0.4% | 59.2% |
...
| CALL_LIST_APPEND ENTER_EXECUTOR | 31,958,580 | 0.3% | 60.5% |
| LOAD_ATTR_WITH_HINT LOAD_ATTR_METHOD_WITH_VALUES | 30,945,200 | 0.3% | 60.8% |
| RESUME_CHECK LOAD_GLOBAL_MODULE | 30,914,600 | 0.3% | 61.2% |
...
| RETURN_VALUE STORE_FAST | 29,834,280 | 0.3% | 62.5% |
| LOAD_FAST BUILD_TUPLE | 29,724,720 | 0.3% | 62.8% |
...
| LOAD_FAST_LOAD_FAST CALL_BUILTIN_FAST | 27,564,680 | 0.3% | 65.5% |
| TO_BOOL_NONE POP_JUMP_IF_TRUE | 27,529,600 | 0.3% | 65.8% |
| POP_JUMP_IF_TRUE NOP | 27,522,660 | 0.3% | 66.1% |
| POP_JUMP_IF_TRUE LOAD_FAST | 27,451,460 | 0.3% | 66.4% |
...
| ENTER_EXECUTOR | 80,736,620 | 28.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_TOP | 80,736,620 | 38.2% |
| POP_JUMP_IF_TRUE | 61,882,840 | 29.3% |
| CALL_LIST_APPEND | 31,958,580 | 15.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 196,349,080 | 10.4% |
| RESUME_CHECK | 188,854,160 | 10.0% |
| POP_JUMP_IF_FALSE | 160,182,520 | 8.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| ENTER_EXECUTOR | 31,958,580 | 57.7% |
...
|---|---:|---:|
| Basic | 4,925,784,000 | 51.9% |
| Not specialized | 904,228,840 | 9.5% |
| Specialized hits | 3,129,290,960 | 33.0% |
...
| Calls to Python functions inlined | 409,383,240 | 88.4% |
...
| Interpreter increfs | 4,577,792,780 | 62.1% |
| Interpreter decrefs | 5,675,317,260 | 68.3% |
| Increfs | 2,792,117,646 | 37.9% |
| Decrefs | 2,636,784,515 | 31.7% |
| Materialize dict (on request) | 113,800 | 1.1% |
| Materialize dict (new key) | 150,400 | 1.4% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 78,600 | 0.7% |
| Method cache hits | 581,237,535 |  |
| Method cache misses | 45,669,665 |  |
| Method cache collisions | 48,551,561 |  |
| Method cache dunder hits | 286,455,881 |  |
| Method cache dunder misses | 2,905,759 |  |
