...
| Increfs | 231,916,248 | 97.8% |
| Decrefs | 246,619,331 | 97.0% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 5,693,651 |  |
| Method cache misses | 860,069 |  |
| Method cache collisions | 873,515 |  |
| Method cache dunder hits | 7,359,163 |  |
| Method cache dunder misses | 13,637 |  |
