...
| Increfs | 460,489,087 | 98.9% |
| Decrefs | 641,488,868 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 4,062,717 |  |
| Method cache misses | 853,383 |  |
| Method cache collisions | 858,075 |  |
| Method cache dunder hits | 1,633,942 |  |
| Method cache dunder misses | 5,178 |  |
