...
| Increfs | 231,916,275 | 97.8% |
| Decrefs | 246,619,988 | 97.0% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 5,693,622 |  |
| Method cache misses | 860,098 |  |
| Method cache collisions | 941,768 |  |
| Method cache dunder hits | 7,290,849 |  |
| Method cache dunder misses | 81,951 |  |
