...
| Increfs | 5,613,289 | 30.4% |
| Decrefs | 8,936,419 | 40.1% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 8,020 |  |
| Method cache misses | 180 |  |
| Method cache collisions | 881 |  |
| Method cache dunder hits | 959,648 |  |
| Method cache dunder misses | 712 |  |
