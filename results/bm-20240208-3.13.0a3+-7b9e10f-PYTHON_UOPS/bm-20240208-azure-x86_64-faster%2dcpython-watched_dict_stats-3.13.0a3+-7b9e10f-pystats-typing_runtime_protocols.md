...
| CALL_ISINSTANCE | 11,118 | 0.0% | 100.0% |  |
...
| IS_OP POP_JUMP_IF_FALSE | 26,936,024 | 3.2% | 11.4% |
...
| LOAD_FAST CALL_TYPE_1 | 9,487,176 | 1.1% | 63.5% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 26,936,024 | 61.6% |
...
| LOAD_ATTR_MODULE | 1,238 | 11.1% |
| LOAD_FAST_LOAD_FAST | 920 | 8.3% |
| LOAD_NAME | 480 | 4.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| TO_BOOL_BOOL | 9,938 | 89.4% |
| POP_TOP | 940 | 8.5% |
...
|---|---:|---:|
| Basic | 390,965,988 | 46.8% |
| Not specialized | 162,572,051 | 19.4% |
| Specialized hits | 282,534,421 | 33.8% |
...
| Allocations | 45,889,464 | 42.9% |
| Allocations to 512 bytes | 45,875,624 | 42.9% |
| Allocations to 4 kbytes | 12,880 | 0.0% |
| Allocations over 4 kbytes | 960 | 0.0% |
| Frees | 45,728,433 |  |
| New values | 2,900 |  |
| Interpreter increfs | 424,169,282 | 62.7% |
| Interpreter decrefs | 489,395,268 | 62.5% |
| Increfs | 252,221,988 | 37.3% |
| Decrefs | 293,623,004 | 37.5% |
| Materialize dict (on request) | 1,040 | 35.9% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 31,977,946 |  |
| Method cache misses | 44,194 |  |
| Method cache collisions | 72,832 |  |
| Method cache dunder hits | 45,443,611 |  |
| Method cache dunder misses | 33,800 |  |
