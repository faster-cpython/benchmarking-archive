...
|---|---:|---:|---:|---:|
| LOAD_FAST | 448,576,158 | 20.3% | 20.3% |  |
| LOAD_ATTR_INSTANCE_VALUE | 129,913,029 | 5.9% | 26.2% |  |
| POP_JUMP_IF_FALSE | 123,603,589 | 5.6% | 31.8% |  |
...
| RESUME | 2,040 | 0.0% | 100.0% | 1,523.7% |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 125,431,729 | 5.7% | 5.7% |
| POP_JUMP_IF_FALSE LOAD_FAST | 90,203,999 | 4.1% | 9.8% |
...
| POP_TOP LOAD_FAST | 39,936,560 | 1.8% | 32.7% |
...
| RETURN_VALUE STORE_FAST | 19,035,210 | 0.9% | 60.1% |
...
| PUSH_NULL CALL | 6,345,510 | 0.3% | 83.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 90,203,999 | 20.1% |
| RESUME_CHECK | 89,570,080 | 20.0% |
| STORE_FAST | 55,254,020 | 12.3% |
| LOAD_CONST | 41,797,650 | 9.3% |
| POP_TOP | 39,936,560 | 8.9% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 125,431,729 | 28.0% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 36,952,730 | 22.3% |
|          hit | 128,463,640 | 77.6% |
|         miss | 761,180 | 0.5% |
...
|---|---:|---:|
| Basic | 1,121,949,978 | 50.7% |
| Not specialized | 261,763,498 | 11.8% |
| Specialized hits | 821,064,333 | 37.1% |
| Specialized misses | 6,175,734 | 0.3% |
...
| Calls to Python functions inlined | 73,524,860 | 58.6% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 56,534,718 | 34.8% |
| Frees to freelist | 56,875,229 |  |
| Allocations | 105,708,720 | 65.2% |
| Allocations to 512 bytes | 104,900,023 | 64.7% |
| Allocations to 4 kbytes | 808,573 | 0.5% |
| Allocations over 4 kbytes | 124 | 0.0% |
| Frees | 105,623,669 |  |
| New values | 440 |  |
| Interpreter increfs | 1,290,239,155 | 79.4% |
| Interpreter decrefs | 1,360,835,897 | 77.0% |
| Increfs | 334,243,056 | 20.6% |
| Decrefs | 405,692,486 | 23.0% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 69,054,449 |  |
| Method cache misses | 172,421 |  |
| Method cache collisions | 172,236 |  |
...
|---:|---:|---:|---:|
| 0 | 55,349 | 2,040 | 378,944,910 |
| 1 | 5,020 | 0 | 392,333,706 |
| 2 | 451 | 0 | 1,013,288,030 |
...
| _CHECK_ATTR_MODULE | 371,830 | 0.0% | 99.7% |  |
| _LOAD_ATTR_MODULE | 371,830 | 0.0% | 99.8% |  |
| _STORE_ATTR_SLOT | 371,830 | 0.0% | 99.8% |  |
| _LOAD_CONST_INLINE | 371,830 | 0.0% | 99.9% |  |
| _CHECK_GLOBALS | 371,830 | 0.0% | 99.9% |  |
