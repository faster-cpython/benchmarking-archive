...
| Increfs | 460,464,954 | 98.9% |
| Decrefs | 641,464,615 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 4,086,846 |  |
| Method cache misses | 829,254 |  |
| Method cache collisions | 828,771 |  |
| Method cache dunder hits | 1,638,998 |  |
