...
|---|---:|---:|---:|---:|
| LOAD_FAST | 3,992,161 | 18.5% | 18.5% |  |
| POP_JUMP_IF_FALSE | 1,138,027 | 5.3% | 23.8% |  |
| LOAD_CONST | 1,135,759 | 5.3% | 29.1% |  |
| RESUME_CHECK | 863,865 | 4.0% | 33.1% | 0.0% |
| LOAD_FAST_LOAD_FAST | 816,884 | 3.8% | 36.9% |  |
| LOAD_ATTR_INSTANCE_VALUE | 776,544 | 3.6% | 40.5% | 0.1% |
...
| COMPARE_OP_INT | 245,408 | 1.1% | 74.6% | 0.1% |
| LOAD_ATTR_METHOD_NO_DICT | 236,285 | 1.1% | 75.7% | 0.4% |
...
| CALL_METHOD_DESCRIPTOR_NOARGS | 115,539 | 0.5% | 88.9% | 8.6% |
| JUMP_FORWARD | 106,923 | 0.5% | 89.4% |  |
| NOP | 99,764 | 0.5% | 89.9% |  |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 751,544 | 3.5% | 3.5% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 400,731 | 1.9% | 17.0% |
...
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 242,731 | 1.1% | 22.3% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 179,151 | 0.8% | 28.9% |
...
| LOAD_GLOBAL_BUILTIN LOAD_GLOBAL_BUILTIN | 105,118 | 0.5% | 50.4% |
| PUSH_NULL LOAD_FAST | 103,865 | 0.5% | 50.9% |
| STORE_ATTR_INSTANCE_VALUE LOAD_FAST_LOAD_FAST | 103,140 | 0.5% | 51.3% |
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 102,432 | 0.5% | 51.8% |
...
| CALL_LEN LOAD_FAST | 92,152 | 0.4% | 54.0% |
...
| LOAD_GLOBAL_BUILTIN | 400,731 | 10.0% |
| LOAD_CONST | 213,298 | 5.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 751,544 | 18.8% |
...
| LOAD_GLOBAL_BUILTIN | 179,151 | 15.7% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 102,432 | 53.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_METHOD_NO_DICT | 50,082 | 43.3% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,232 | 8.2% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 242,731 | 98.9% |
...
| CALL_METHOD_DESCRIPTOR_NOARGS | 50,082 | 21.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 179,151 | 29.1% |
...
|---|---:|---:|
| Basic | 10,670,374 | 49.5% |
| Not specialized | 3,470,027 | 16.1% |
| Specialized hits | 7,324,032 | 34.0% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 776,599 | 32.6% |
| Frees to freelist | 780,722 |  |
| Allocations | 1,603,633 | 67.4% |
| Allocations to 512 bytes | 1,413,367 | 59.4% |
| Allocations to 4 kbytes | 132,427 | 5.6% |
| Allocations over 4 kbytes | 57,839 | 2.4% |
| Frees | 1,542,604 |  |
| New values | 34,900 |  |
| Interpreter increfs | 12,352,491 | 76.8% |
| Interpreter decrefs | 14,168,189 | 78.3% |
| Increfs | 3,730,300 | 23.2% |
| Decrefs | 3,919,635 | 21.7% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 1,226,004 |  |
| Method cache misses | 34,129 |  |
| Method cache collisions | 40,941 |  |
| Method cache dunder hits | 354,758 |  |
| Method cache dunder misses | 9,127 |  |
