...
|---|---:|---:|---:|---:|
| FOR_ITER_TUPLE | 41,560 | 27.2% | 27.2% |  |
| ENTER_EXECUTOR | 41,200 | 27.0% | 54.2% |  |
| LOAD_FAST | 13,360 | 8.8% | 63.0% |  |
| PUSH_NULL | 12,800 | 8.4% | 71.4% |  |
| POP_TOP | 12,480 | 8.2% | 79.5% |  |
| LOAD_FAST_LOAD_FAST | 12,400 | 8.1% | 87.7% |  |
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 12,000 | 7.9% | 95.5% |  |
| STORE_FAST | 1,420 | 0.9% | 96.5% |  |
| CALL | 1,140 | 0.7% | 97.2% |  |
| JUMP_BACKWARD | 680 | 0.4% | 97.7% |  |
| GET_ITER | 480 | 0.3% | 98.0% |  |
| FOR_ITER_RANGE | 460 | 0.3% | 98.3% |  |
| LOAD_GLOBAL_MODULE | 360 | 0.2% | 98.5% |  |
| LOAD_GLOBAL | 280 | 0.2% | 98.7% |  |
| LOAD_DEREF | 240 | 0.2% | 98.8% |  |
| LOAD_ATTR_MODULE | 240 | 0.2% | 99.0% |  |
| LOAD_ATTR | 200 | 0.1% | 99.1% |  |
...
|---|---:|---:|---:|
| ENTER_EXECUTOR FOR_ITER_TUPLE | 40,840 | 26.8% | 26.8% |
| FOR_ITER_TUPLE ENTER_EXECUTOR | 40,620 | 26.6% | 53.4% |
| PUSH_NULL LOAD_FAST_LOAD_FAST | 12,400 | 8.1% | 61.5% |
| LOAD_FAST PUSH_NULL | 12,400 | 8.1% | 69.6% |
| CALL_BUILTIN_FAST_WITH_KEYWORDS POP_TOP | 12,000 | 7.9% | 77.5% |
| POP_TOP LOAD_FAST | 11,780 | 7.7% | 85.2% |
| LOAD_FAST_LOAD_FAST CALL_BUILTIN_FAST_WITH_KEYWORDS | 11,600 | 7.6% | 92.8% |
| STORE_FAST LOAD_FAST | 1,260 | 0.8% | 93.6% |
| LOAD_FAST_LOAD_FAST CALL | 800 | 0.5% | 94.2% |
| FOR_ITER_TUPLE STORE_FAST | 600 | 0.4% | 94.5% |
| CALL POP_TOP | 480 | 0.3% | 94.9% |
| LOAD_FAST GET_ITER | 480 | 0.3% | 95.2% |
| CALL CALL_BUILTIN_FAST_WITH_KEYWORDS | 400 | 0.3% | 95.4% |
| GET_ITER FOR_ITER_TUPLE | 380 | 0.2% | 95.7% |
| FOR_ITER_RANGE STORE_FAST | 380 | 0.2% | 95.9% |
| POP_TOP JUMP_BACKWARD | 340 | 0.2% | 96.2% |
| FOR_ITER_TUPLE JUMP_BACKWARD | 340 | 0.2% | 96.4% |
| JUMP_BACKWARD FOR_ITER_TUPLE | 320 | 0.2% | 96.6% |
| JUMP_BACKWARD FOR_ITER_RANGE | 300 | 0.2% | 96.8% |
| POP_TOP ENTER_EXECUTOR | 280 | 0.2% | 97.0% |
| ENTER_EXECUTOR ENTER_EXECUTOR | 280 | 0.2% | 97.2% |
| PUSH_NULL CALL | 240 | 0.2% | 97.3% |
| LOAD_ATTR_MODULE PUSH_NULL | 180 | 0.1% | 97.4% |
| PUSH_NULL LOAD_FAST | 160 | 0.1% | 97.5% |
| LOAD_DEREF PUSH_NULL | 160 | 0.1% | 97.6% |
| LOAD_GLOBAL LOAD_GLOBAL_MODULE | 120 | 0.1% | 97.7% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 120 | 0.1% | 97.8% |
| CALL STORE_FAST | 100 | 0.1% | 97.9% |
| NOP LOAD_DEREF | 80 | 0.1% | 97.9% |
| POP_TOP NOP | 80 | 0.1% | 98.0% |
| RETURN_VALUE RETURN_VALUE | 80 | 0.1% | 98.0% |
| BUILD_LIST LOAD_DEREF | 80 | 0.1% | 98.1% |
| BUILD_TUPLE STORE_FAST | 80 | 0.1% | 98.1% |
| CALL LOAD_FAST | 80 | 0.1% | 98.2% |
| CALL_FUNCTION_EX COPY_FREE_VARS | 80 | 0.1% | 98.2% |
| CALL_INTRINSIC_1 CALL_FUNCTION_EX | 80 | 0.1% | 98.3% |
| ENTER_EXECUTOR FOR_ITER_RANGE | 80 | 0.1% | 98.3% |
| LIST_EXTEND CALL_INTRINSIC_1 | 80 | 0.1% | 98.4% |
| LOAD_ATTR LOAD_ATTR_MODULE | 80 | 0.1% | 98.4% |
| LOAD_DEREF LIST_EXTEND | 80 | 0.1% | 98.5% |
| LOAD_FAST BUILD_LIST | 80 | 0.1% | 98.5% |
| LOAD_FAST CALL_FUNCTION_EX | 80 | 0.1% | 98.6% |
| LOAD_FAST LOAD_ATTR | 80 | 0.1% | 98.7% |
| STORE_FAST LOAD_GLOBAL | 80 | 0.1% | 98.7% |
| STORE_FAST LOAD_GLOBAL_MODULE | 80 | 0.1% | 98.8% |
| LOAD_GLOBAL_MODULE LOAD_GLOBAL_MODULE | 80 | 0.1% | 98.8% |
| GET_ITER FOR_ITER_RANGE | 60 | 0.0% | 98.8% |
| CALL CALL | 60 | 0.0% | 98.9% |
| CALL_FUNCTION_EX RESUME_CHECK | 60 | 0.0% | 98.9% |
| COPY_FREE_VARS RESUME_CHECK | 60 | 0.0% | 99.0% |
| LOAD_ATTR PUSH_NULL | 60 | 0.0% | 99.0% |
| LOAD_GLOBAL LOAD_ATTR | 60 | 0.0% | 99.0% |
| BINARY_OP_SUBTRACT_FLOAT RETURN_VALUE | 60 | 0.0% | 99.1% |
| CALL_BUILTIN_CLASS STORE_FAST | 60 | 0.0% | 99.1% |
...
|---|---:|---:|
| Basic | 95,900 | 62.8% |
| Not specialized | 1,740 | 1.1% |
| Specialized hits | 54,980 | 36.0% |
...
| Frees | 22,997,123 |  |
| New values | 0 |  |
| Interpreter increfs | 5,162,740 | 2.2% |
| Interpreter decrefs | 7,722,960 | 3.0% |
| Increfs | 231,875,440 | 97.8% |
| Decrefs | 246,578,209 | 97.0% |
...
| Method cache collisions | 819,251 |  |
| Method cache dunder hits | 7,372,578 |  |
...
| Uops executed | 20,742,280 | 253.51 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 7,376,160 | 35.6% | 35.6% |  |
| _SET_IP | 2,526,400 | 12.2% | 47.7% |  |
| _CHECK_VALIDITY | 2,526,320 | 12.2% | 59.9% |  |
| POP_TOP | 2,445,200 | 11.8% | 71.7% |  |
| PUSH_NULL | 2,445,200 | 11.8% | 83.5% |  |
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 2,445,200 | 11.8% | 95.3% |  |
| _GUARD_NOT_EXHAUSTED_TUPLE | 163,120 | 0.8% | 96.1% | 25.0% |
| _ITER_CHECK_TUPLE | 163,120 | 0.8% | 96.9% |  |
| STORE_FAST | 162,820 | 0.8% | 97.6% |  |
| _ITER_NEXT_TUPLE | 122,260 | 0.6% | 98.2% |  |
| _JUMP_TO_TOP | 81,700 | 0.4% | 98.6% |  |
| _START_EXECUTOR | 81,500 | 0.4% | 99.0% |  |
