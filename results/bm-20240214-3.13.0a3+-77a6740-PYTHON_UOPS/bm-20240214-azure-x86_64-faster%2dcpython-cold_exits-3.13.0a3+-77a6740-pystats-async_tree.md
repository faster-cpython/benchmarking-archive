...
| ENTER_EXECUTOR | 18,661,160 | 1.0% | 88.8% |  |
...
| RESUME | 1,640 | 0.0% | 100.0% | 2,662.2% |
...
| ENTER_EXECUTOR CALL_FUNCTION_EX | 9,702,500 | 0.5% | 72.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| CALL_FUNCTION_EX | 9,702,500 | 52.0% |
| CALL | 3,732,100 | 20.0% |
| CALL_KW | 3,732,100 | 20.0% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 43,303,620 | 29.6% |
|          hit | 103,040,840 | 70.4% |
|         miss | 4,565,360 | 3.1% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 29,121,340 | 12.0% |
|          hit | 214,295,780 | 88.0% |
...
|---|---:|---:|
| Basic | 1,021,384,920 | 52.8% |
| Not specialized | 240,453,580 | 12.4% |
| Specialized hits | 668,951,280 | 34.6% |
| Specialized misses | 4,609,100 | 0.2% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 44,044,000 | 40.4% |
| Calls to Python functions inlined | 64,959,860 | 59.6% |
| Calls via PyEval_EvalFrame (total) | 44,044,000 | 40.4% |
| Calls via PyEval_EvalFrame (vector) | 38,818,560 | 35.6% |
| Calls via PyEval_EvalFrame (generator) | 5,225,440 | 4.8% |
| Calls via PyEval_EvalFrame (legacy) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 38,818,560 | 35.6% |
| Calls via PyEval_EvalFrame (build class) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (slot) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (function ex) | 746,560 | 0.7% |
| Calls via PyEval_EvalFrame (api) | 4,479,100 | 4.1% |
| Calls via PyEval_EvalFrame (method) | 19,408,800 | 17.8% |
| Frame objects created | 180 | 0.0% |
| Frames pushed | 61,223,300 | 56.2% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 58,343,880 | 37.2% |
| Frees to freelist | 58,597,880 |  |
| Allocations | 98,662,044 | 62.8% |
| Allocations to 512 bytes | 98,603,480 | 62.8% |
| Allocations to 4 kbytes | 58,460 | 0.0% |
| Allocations over 4 kbytes | 104 | 0.0% |
| Frees | 100,807,292 |  |
| New values | 420 |  |
| Interpreter increfs | 1,171,361,260 | 78.8% |
| Interpreter decrefs | 1,221,920,020 | 75.2% |
| Increfs | 315,225,496 | 21.2% |
| Decrefs | 401,909,501 | 24.8% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 80,352,910 |  |
| Method cache misses | 3,277,030 |  |
| Method cache collisions | 3,273,240 |  |
| Method cache dunder hits | 10,452,291 |  |
...
|---:|---:|---:|---:|
| 0 | 49,260 | 2,040 | 257,850,400 |
| 1 | 4,480 | 0 | 278,831,200 |
| 2 | 380 | 0 | 753,109,360 |
...
| Trace too short | 536,440 | 22,351.7% |
| Inner loop found | 0 | 0.0% |
| Recursive call | 2,300 | 95.8% |
| Low confidence | 0 | 0.0% |
| Traces executed | 35,827,980 |  |
| Uops executed | 763,534,660 | 21.31 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 90,310,360 | 11.8% | 11.8% |  |
| _GUARD_TYPE_VERSION | 77,620,160 | 10.2% | 22.0% |  |
| _SET_IP | 69,413,040 | 9.1% | 31.1% |  |
| _CHECK_VALIDITY | 69,411,480 | 9.1% | 40.2% |  |
| _LOAD_ATTR_SLOT | 38,810,080 | 5.1% | 45.3% |  |
| _CHECK_VALIDITY_AND_SET_IP | 32,839,680 | 4.3% | 49.6% |  |
| STORE_FAST | 26,869,280 | 3.5% | 53.1% |  |
| TO_BOOL_BOOL | 23,137,160 | 3.0% | 56.1% |  |
| _GUARD_IS_FALSE_POP | 23,137,160 | 3.0% | 59.1% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 19,405,040 | 2.5% | 61.7% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 19,405,040 | 2.5% | 64.2% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 19,405,040 | 2.5% | 66.8% |  |
| _START_EXECUTOR | 18,661,220 | 2.4% | 69.2% |  |
| _EXIT_TRACE | 17,166,760 | 2.2% | 71.5% | 100.0% |
| _LOAD_ATTR | 17,166,760 | 2.2% | 73.7% |  |
| _COLD_EXIT | 17,166,760 | 2.2% | 76.0% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 13,434,640 | 1.8% | 77.7% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 9,704,080 | 1.3% | 79.0% | 0.0% |
| _ITER_CHECK_RANGE | 9,704,080 | 1.3% | 80.3% |  |
| PUSH_NULL | 9,702,520 | 1.3% | 81.5% |  |
| BUILD_LIST | 9,702,520 | 1.3% | 82.8% |  |
| CALL_INTRINSIC_1 | 9,702,520 | 1.3% | 84.1% |  |
| LIST_EXTEND | 9,702,520 | 1.3% | 85.3% |  |
| RESUME_CHECK | 9,702,520 | 1.3% | 86.6% |  |
| _ITER_NEXT_RANGE | 9,702,520 | 1.3% | 87.9% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 9,702,520 | 1.3% | 89.1% |  |
| _CHECK_STACK_SPACE | 9,702,520 | 1.3% | 90.4% |  |
| _INIT_CALL_PY_EXACT_ARGS | 9,702,520 | 1.3% | 91.7% |  |
| _PUSH_FRAME | 9,702,520 | 1.3% | 93.0% |  |
| _SAVE_RETURN_OFFSET | 9,702,520 | 1.3% | 94.2% |  |
| _GUARD_NOT_EXHAUSTED_TUPLE | 4,478,580 | 0.6% | 94.8% | 16.7% |
| _ITER_CHECK_TUPLE | 4,478,580 | 0.6% | 95.4% |  |
| _GUARD_NOT_EXHAUSTED_LIST | 4,478,560 | 0.6% | 96.0% | 16.7% |
| _ITER_CHECK_LIST | 4,478,560 | 0.6% | 96.6% |  |
| CONTAINS_OP | 3,732,120 | 0.5% | 97.1% |  |
| _ITER_NEXT_LIST | 3,732,120 | 0.5% | 97.6% |  |
| _ITER_NEXT_TUPLE | 3,732,120 | 0.5% | 98.0% |  |
| _GUARD_IS_TRUE_POP | 3,732,120 | 0.5% | 98.5% |  |
| _LOAD_CONST_INLINE | 3,732,120 | 0.5% | 99.0% |  |
| _LOAD_CONST_INLINE_WITH_NULL | 3,732,120 | 0.5% | 99.5% |  |
| _CHECK_GLOBALS | 3,732,120 | 0.5% | 100.0% |  |
