...
| PUSH_NULL | 4,400 | 17.2% | 34.9% |  |
| POP_TOP | 4,080 | 15.9% | 50.9% |  |
| LOAD_FAST_LOAD_FAST | 4,000 | 15.6% | 66.5% |  |
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 3,800 | 14.8% | 81.3% |  |
| STORE_FAST | 800 | 3.1% | 84.4% |  |
| CALL | 740 | 2.9% | 87.3% |  |
| FOR_ITER_RANGE | 460 | 1.8% | 89.1% |  |
| JUMP_BACKWARD | 340 | 1.3% | 90.4% |  |
| LOAD_DEREF | 240 | 0.9% | 91.3% |  |
| LOAD_ATTR_MODULE | 240 | 0.9% | 92.3% |  |
| LOAD_GLOBAL_MODULE | 240 | 0.9% | 93.2% |  |
| LOAD_ATTR | 200 | 0.8% | 94.0% |  |
...
| POP_TOP LOAD_FAST | 3,600 | 14.0% | 60.1% |
| LOAD_FAST_LOAD_FAST CALL_BUILTIN_FAST_WITH_KEYWORDS | 3,600 | 14.0% | 74.1% |
| STORE_FAST LOAD_FAST | 640 | 2.5% | 76.6% |
| LOAD_FAST_LOAD_FAST CALL | 400 | 1.6% | 78.2% |
| FOR_ITER_RANGE STORE_FAST | 380 | 1.5% | 79.6% |
| POP_TOP JUMP_BACKWARD | 340 | 1.3% | 81.0% |
| JUMP_BACKWARD FOR_ITER_RANGE | 320 | 1.2% | 82.2% |
| CALL POP_TOP | 280 | 1.1% | 83.3% |
| PUSH_NULL CALL | 240 | 0.9% | 84.2% |
| CALL CALL_BUILTIN_FAST_WITH_KEYWORDS | 200 | 0.8% | 85.0% |
| LOAD_ATTR_MODULE PUSH_NULL | 180 | 0.7% | 85.7% |
| PUSH_NULL LOAD_FAST | 160 | 0.6% | 86.3% |
| LOAD_DEREF PUSH_NULL | 160 | 0.6% | 87.0% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 120 | 0.5% | 87.4% |
| CALL STORE_FAST | 100 | 0.4% | 87.8% |
| NOP LOAD_DEREF | 80 | 0.3% | 88.1% |
| POP_TOP NOP | 80 | 0.3% | 88.5% |
| RETURN_VALUE RETURN_VALUE | 80 | 0.3% | 88.8% |
...
| LIST_EXTEND CALL_INTRINSIC_1 | 80 | 0.3% | 90.3% |
| LOAD_ATTR LOAD_ATTR_MODULE | 80 | 0.3% | 90.6% |
| LOAD_DEREF LIST_EXTEND | 80 | 0.3% | 91.0% |
| LOAD_FAST GET_ITER | 80 | 0.3% | 91.3% |
| LOAD_FAST BUILD_LIST | 80 | 0.3% | 91.6% |
| LOAD_FAST CALL_FUNCTION_EX | 80 | 0.3% | 91.9% |
| LOAD_FAST LOAD_ATTR | 80 | 0.3% | 92.2% |
| LOAD_GLOBAL LOAD_GLOBAL_MODULE | 80 | 0.3% | 92.5% |
| STORE_FAST LOAD_GLOBAL | 80 | 0.3% | 92.8% |
| STORE_FAST LOAD_GLOBAL_MODULE | 80 | 0.3% | 93.1% |
| GET_ITER FOR_ITER_RANGE | 60 | 0.2% | 93.4% |
| POP_TOP ENTER_EXECUTOR | 60 | 0.2% | 93.6% |
| CALL CALL | 60 | 0.2% | 93.8% |
| CALL_FUNCTION_EX RESUME_CHECK | 60 | 0.2% | 94.1% |
| COPY_FREE_VARS RESUME_CHECK | 60 | 0.2% | 94.3% |
| ENTER_EXECUTOR FOR_ITER_RANGE | 60 | 0.2% | 94.5% |
| LOAD_ATTR PUSH_NULL | 60 | 0.2% | 94.8% |
| LOAD_GLOBAL LOAD_ATTR | 60 | 0.2% | 95.0% |
| BINARY_OP_SUBTRACT_FLOAT RETURN_VALUE | 60 | 0.2% | 95.2% |
| CALL_BUILTIN_CLASS STORE_FAST | 60 | 0.2% | 95.5% |
| LOAD_ATTR_MODULE STORE_FAST | 60 | 0.2% | 95.7% |
| LOAD_ATTR_WITH_HINT STORE_FAST | 60 | 0.2% | 95.9% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 60 | 0.2% | 96.2% |
| LOAD_GLOBAL_MODULE LOAD_ATTR | 60 | 0.2% | 96.4% |
| LOAD_GLOBAL_MODULE STORE_FAST | 60 | 0.2% | 96.6% |
| RESUME_CHECK LOAD_DEREF | 60 | 0.2% | 96.9% |
| RETURN_VALUE LOAD_GLOBAL | 40 | 0.2% | 97.0% |
| RETURN_VALUE LOAD_GLOBAL_MODULE | 40 | 0.2% | 97.2% |
| LOAD_ATTR STORE_FAST | 40 | 0.2% | 97.3% |
| LOAD_FAST BINARY_OP | 40 | 0.2% | 97.5% |
| LOAD_FAST CALL | 40 | 0.2% | 97.7% |
| LOAD_FAST BINARY_OP_SUBTRACT_FLOAT | 40 | 0.2% | 97.8% |
| LOAD_FAST CALL_BUILTIN_CLASS | 40 | 0.2% | 98.0% |
| LOAD_FAST LOAD_ATTR_MODULE | 40 | 0.2% | 98.1% |
| LOAD_FAST LOAD_ATTR_WITH_HINT | 40 | 0.2% | 98.3% |
| FOR_ITER_RANGE LOAD_GLOBAL | 40 | 0.2% | 98.4% |
| FOR_ITER_RANGE LOAD_GLOBAL_MODULE | 40 | 0.2% | 98.6% |
| RESUME_CHECK LOAD_GLOBAL_BUILTIN | 40 | 0.2% | 98.8% |
| GET_ITER FOR_ITER | 20 | 0.1% | 98.8% |
| BINARY_OP RETURN_VALUE | 20 | 0.1% | 98.9% |
| BINARY_OP BINARY_OP_SUBTRACT_FLOAT | 20 | 0.1% | 99.0% |
| CALL CALL_BUILTIN_CLASS | 20 | 0.1% | 99.1% |
| CALL_FUNCTION_EX RESUME | 20 | 0.1% | 99.1% |
| COPY_FREE_VARS RESUME | 20 | 0.1% | 99.2% |
| FOR_ITER STORE_FAST | 20 | 0.1% | 99.3% |
| FOR_ITER FOR_ITER_RANGE | 20 | 0.1% | 99.4% |
...
| Frees | 11,612,405 |  |
| New values | 0 |  |
| Interpreter increfs | 3,278,940 | 3.0% |
| Interpreter decrefs | 5,061,060 | 4.5% |
| Increfs | 104,858,400 | 97.0% |
| Decrefs | 108,135,265 | 95.5% |
...
| Traces executed | 80 |  |
| Uops executed | 14,219,600 | 177,745.00 |
