...
|---|---:|---:|---:|---:|
| LOAD_FAST | 80,017,960 | 18.5% | 18.5% |  |
| STORE_ATTR_SLOT | 48,003,760 | 11.1% | 29.6% |  |
...
| CALL_BUILTIN_O | 32,000,420 | 7.4% | 66.7% |  |
| STORE_FAST | 16,029,420 | 3.7% | 70.4% |  |
| ENTER_EXECUTOR | 16,024,780 | 3.7% | 74.1% |  |
...
| LOAD_ATTR_SLOT | 8,580 | 0.0% | 100.0% |  |
| POP_JUMP_IF_FALSE | 1,840 | 0.0% | 100.0% |  |
| COMPARE_OP_FLOAT | 1,700 | 0.0% | 100.0% |  |
...
|---|---:|---:|---:|
| LOAD_FAST STORE_ATTR_SLOT | 48,002,240 | 11.1% | 11.1% |
...
| CALL_BUILTIN_O COPY | 15,999,980 | 3.7% | 77.8% |
| CALL_BUILTIN_O LOAD_CONST | 15,999,980 | 3.7% | 81.5% |
| STORE_ATTR_SLOT LOAD_FAST_LOAD_FAST | 15,999,980 | 3.7% | 85.2% |
| STORE_ATTR_SLOT STORE_FAST | 15,999,980 | 3.7% | 88.9% |
| LOAD_FAST_LOAD_FAST STORE_SUBSCR_LIST_INT | 15,999,960 | 3.7% | 92.6% |
| STORE_SUBSCR_LIST_INT ENTER_EXECUTOR | 15,999,660 | 3.7% | 96.3% |
| ENTER_EXECUTOR CALL | 15,999,500 | 3.7% | 100.0% |
| RETURN_VALUE STORE_FAST | 25,180 | 0.0% | 100.0% |
| STORE_FAST ENTER_EXECUTOR | 24,840 | 0.0% | 100.0% |
| ENTER_EXECUTOR RETURN_VALUE | 23,940 | 0.0% | 100.0% |
| BINARY_OP BINARY_OP | 8,460 | 0.0% | 100.0% |
| LOAD_FAST LOAD_ATTR_SLOT | 6,920 | 0.0% | 100.0% |
| LOAD_ATTR_SLOT LOAD_FAST | 4,640 | 0.0% | 100.0% |
| CALL CALL | 4,200 | 0.0% | 100.0% |
| STORE_ATTR_SLOT LOAD_FAST | 3,360 | 0.0% | 100.0% |
| STORE_FAST LOAD_FAST | 3,040 | 0.0% | 100.0% |
| COMPARE_OP_FLOAT POP_JUMP_IF_FALSE | 1,700 | 0.0% | 100.0% |
| LOAD_FAST BINARY_OP | 1,640 | 0.0% | 100.0% |
| LOAD_ATTR_SLOT COMPARE_OP_FLOAT | 1,640 | 0.0% | 100.0% |
| POP_JUMP_IF_FALSE LOAD_FAST | 1,620 | 0.0% | 100.0% |
| LOAD_FAST RETURN_VALUE | 1,480 | 0.0% | 100.0% |
...
| ENTER_EXECUTOR FOR_ITER_LIST | 300 | 0.0% | 100.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| ENTER_EXECUTOR | 15,999,500 | 100.0% |
| CALL | 4,200 | 0.0% |
| LOAD_FAST | 720 | 0.0% |
| PUSH_NULL | 400 | 0.0% |
| BINARY_OP | 20 | 0.0% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| CALL | 15,999,500 | 99.8% |
| RETURN_VALUE | 23,940 | 0.1% |
| LOAD_FAST | 880 | 0.0% |
...
| LOAD_ATTR_SLOT | 4,640 | 0.0% |
| STORE_ATTR_SLOT | 3,360 | 0.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_ATTR_SLOT | 48,002,240 | 60.0% |
| CALL_BUILTIN_O | 31,999,920 | 40.0% |
| LOAD_ATTR_SLOT | 6,920 | 0.0% |
| BINARY_OP | 1,640 | 0.0% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| COMPARE_OP_FLOAT | 1,700 | 92.4% |
| COMPARE_OP | 80 | 4.3% |
| COMPARE_OP_INT | 60 | 3.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 1,620 | 88.0% |
| ENTER_EXECUTOR | 140 | 7.6% |
| LOAD_GLOBAL | 40 | 2.2% |
| LOAD_GLOBAL_BUILTIN | 40 | 2.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 620 | 50.0% |
| ENTER_EXECUTOR | 300 | 24.2% |
| GET_ITER | 280 | 22.6% |
| FOR_ITER | 40 | 3.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 6,920 | 80.7% |
| COPY | 1,320 | 15.4% |
| LOAD_ATTR | 340 | 4.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 4,640 | 54.1% |
| COMPARE_OP_FLOAT | 1,640 | 19.1% |
| STORE_FAST | 1,380 | 16.1% |
| JUMP_FORWARD | 860 | 10.0% |
| COMPARE_OP | 60 | 0.7% |
...
|---|---:|---:|
| Basic | 224,107,940 | 51.9% |
| Not specialized | 48,019,220 | 11.1% |
| Specialized hits | 160,001,200 | 37.0% |
...
| Allocations | 79,992,900 | 29.4% |
| Allocations to 512 bytes | 79,992,520 | 29.4% |
| Allocations to 4 kbytes | 60 | 0.0% |
| Allocations over 4 kbytes | 320 | 0.0% |
| Frees | 79,999,643 |  |
| New values | 0 |  |
| Interpreter increfs | 1,199,842,180 | 94.9% |
| Interpreter decrefs | 1,359,803,580 | 88.5% |
| Increfs | 63,961,760 | 5.1% |
| Decrefs | 176,012,164 | 11.5% |
...
|---:|---:|---:|---:|
| 0 | 20,700 | 1,920 | 140,038,560 |
| 1 | 1,880 | 0 | 152,879,440 |
| 2 | 160 | 0 | 118,288,040 |
...
| Traces created | 120 | 200.0% |
| Trace stack overflow | 0 | 0.0% |
| Trace stack underflow | 800 | 1,333.3% |
| Trace too long | 0 | 0.0% |
| Trace too short | 500,720 | 834,533.3% |
| Inner loop found | 0 | 0.0% |
| Recursive call | 0 | 0.0% |
| Low confidence | 0 | 0.0% |
| Traces executed | 32,073,620 |  |
| Uops executed | 2,895,864,180 | 90.29 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 511,978,680 | 17.7% | 17.7% |  |
| _GUARD_TYPE_VERSION | 367,984,080 | 12.7% | 30.4% |  |
| _SET_IP | 287,963,980 | 9.9% | 40.3% |  |
| _LOAD_ATTR_SLOT | 239,989,640 | 8.3% | 48.6% |  |
| _CHECK_VALIDITY | 239,965,260 | 8.3% | 56.9% |  |
| STORE_FAST | 127,971,140 | 4.4% | 61.3% |  |
| _STORE_ATTR_SLOT | 95,995,560 | 3.3% | 64.6% |  |
| _GUARD_BOTH_FLOAT | 79,997,600 | 2.8% | 67.4% |  |
| COPY | 47,998,560 | 1.7% | 69.1% |  |
| SWAP | 47,998,560 | 1.7% | 70.7% |  |
| _BINARY_OP_MULTIPLY_FLOAT | 47,998,560 | 1.7% | 72.4% |  |
| _BINARY_OP | 47,998,560 | 1.7% | 74.0% |  |
| COMPARE_OP_FLOAT | 47,997,760 | 1.7% | 75.7% |  |
| _GUARD_IS_TRUE_POP | 47,985,340 | 1.7% | 77.3% | 0.1% |
| _GUARD_NOT_EXHAUSTED_LIST | 31,999,200 | 1.1% | 78.5% | 0.0% |
| _ITER_CHECK_LIST | 31,999,200 | 1.1% | 79.6% |  |
| _BINARY_OP_ADD_FLOAT | 31,999,040 | 1.1% | 80.7% |  |
| _LOAD_CONST_INLINE_WITH_NULL | 31,999,040 | 1.1% | 81.8% |  |
| _CHECK_GLOBALS | 31,999,040 | 1.1% | 82.9% |  |
| _CHECK_VALIDITY_AND_SET_IP | 31,999,040 | 1.1% | 84.0% |  |
| RESUME_CHECK | 31,998,880 | 1.1% | 85.1% |  |
| _ITER_NEXT_LIST | 31,998,880 | 1.1% | 86.2% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 31,998,880 | 1.1% | 87.3% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 31,998,880 | 1.1% | 88.4% |  |
| _CHECK_STACK_SPACE | 31,998,880 | 1.1% | 89.5% |  |
| _INIT_CALL_PY_EXACT_ARGS | 31,998,880 | 1.1% | 90.6% |  |
| _PUSH_FRAME | 31,998,880 | 1.1% | 91.7% |  |
| _SAVE_RETURN_OFFSET | 31,998,880 | 1.1% | 92.8% |  |
| _POP_FRAME | 31,974,180 | 1.1% | 93.9% |  |
| _JUMP_TO_TOP | 31,974,180 | 1.1% | 95.0% |  |
| _START_EXECUTOR | 16,049,200 | 0.6% | 95.6% |  |
| _COLD_EXIT | 16,024,420 | 0.6% | 96.1% |  |
| _EXIT_TRACE | 16,023,460 | 0.6% | 96.7% | 100.0% |
| _GUARD_NOT_EXHAUSTED_RANGE | 15,999,680 | 0.6% | 97.2% | 0.0% |
| _ITER_CHECK_RANGE | 15,999,680 | 0.6% | 97.8% |  |
...
| _GUARD_IS_FALSE_POP | 12,420 | 0.0% | 100.0% | 4.5% |
