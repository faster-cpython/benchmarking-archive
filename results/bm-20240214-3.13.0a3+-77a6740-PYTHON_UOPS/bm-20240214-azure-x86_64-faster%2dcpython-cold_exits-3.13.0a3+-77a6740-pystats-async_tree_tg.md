...
| ENTER_EXECUTOR | 9,704,080 | 0.6% | 96.6% |  |
...
| RESUME | 1,720 | 0.0% | 100.0% | 1,532.6% |
...
| ENTER_EXECUTOR CALL_FUNCTION_EX | 9,702,500 | 0.6% | 82.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| CALL_FUNCTION_EX | 9,702,500 | 100.0% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 28,374,780 | 10.3% |
|          hit | 247,886,900 | 89.7% |
...
|---|---:|---:|
| Basic | 890,002,220 | 51.1% |
| Not specialized | 216,564,980 | 12.4% |
| Specialized hits | 635,374,760 | 36.5% |
| Specialized misses | 787,620 | 0.0% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 44,790,500 | 43.5% |
| Calls to Python functions inlined | 58,241,520 | 56.5% |
| Calls via PyEval_EvalFrame (total) | 44,790,500 | 43.5% |
| Calls via PyEval_EvalFrame (vector) | 39,565,060 | 38.4% |
| Calls via PyEval_EvalFrame (generator) | 5,225,440 | 5.1% |
| Calls via PyEval_EvalFrame (legacy) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 39,565,060 | 38.4% |
| Calls via PyEval_EvalFrame (build class) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (slot) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (function ex) | 80 | 0.0% |
| Calls via PyEval_EvalFrame (api) | 4,479,100 | 4.3% |
| Calls via PyEval_EvalFrame (method) | 19,408,800 | 18.8% |
| Frame objects created | 180 | 0.0% |
| Frames pushed | 53,758,460 | 52.2% |
...
| Allocations | 94,277,342 | 65.0% |
| Allocations to 512 bytes | 93,472,300 | 64.4% |
| Allocations to 4 kbytes | 804,940 | 0.6% |
| Allocations over 4 kbytes | 102 | 0.0% |
| Frees | 94,234,283 |  |
| New values | 440 |  |
| Interpreter increfs | 1,073,572,760 | 79.5% |
| Interpreter decrefs | 1,130,850,120 | 76.5% |
| Increfs | 276,218,788 | 20.5% |
| Decrefs | 346,495,238 | 23.5% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 57,498,770 |  |
| Method cache misses | 3,890 |  |
| Method cache collisions | 3,769 |  |
| Method cache dunder hits | 11,198,816 |  |
...
|---:|---:|---:|---:|
| 0 | 51,280 | 2,040 | 274,480,640 |
| 1 | 4,660 | 0 | 296,833,280 |
| 2 | 400 | 0 | 849,301,040 |
...
| Trace too short | 303,200 | 12,847.5% |
| Inner loop found | 0 | 0.0% |
| Recursive call | 2,300 | 97.5% |
| Low confidence | 0 | 0.0% |
| Traces executed | 19,406,620 |  |
| Uops executed | 620,967,580 | 32.00 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| _GUARD_TYPE_VERSION | 77,620,160 | 12.5% | 12.5% |  |
| LOAD_FAST | 67,917,640 | 10.9% | 23.4% |  |
| _SET_IP | 58,216,680 | 9.4% | 32.8% |  |
| _CHECK_VALIDITY | 58,215,120 | 9.4% | 42.2% |  |
| _LOAD_ATTR_SLOT | 38,810,080 | 6.2% | 48.4% |  |
| _CHECK_VALIDITY_AND_SET_IP | 29,107,560 | 4.7% | 53.1% |  |
| STORE_FAST | 19,405,040 | 3.1% | 56.2% |  |
| TO_BOOL_BOOL | 19,405,040 | 3.1% | 59.4% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 19,405,040 | 3.1% | 62.5% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 19,405,040 | 3.1% | 65.6% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 19,405,040 | 3.1% | 68.7% |  |
| _GUARD_IS_FALSE_POP | 19,405,040 | 3.1% | 71.9% |  |
| _START_EXECUTOR | 9,704,100 | 1.6% | 73.4% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 9,704,080 | 1.6% | 75.0% | 0.0% |
| _ITER_CHECK_RANGE | 9,704,080 | 1.6% | 76.6% |  |
| _EXIT_TRACE | 9,702,520 | 1.6% | 78.1% | 100.0% |
| PUSH_NULL | 9,702,520 | 1.6% | 79.7% |  |
| BUILD_LIST | 9,702,520 | 1.6% | 81.3% |  |
| CALL_INTRINSIC_1 | 9,702,520 | 1.6% | 82.8% |  |
| LIST_EXTEND | 9,702,520 | 1.6% | 84.4% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 9,702,520 | 1.6% | 85.9% |  |
| RESUME_CHECK | 9,702,520 | 1.6% | 87.5% |  |
| _LOAD_ATTR | 9,702,520 | 1.6% | 89.1% |  |
| _ITER_NEXT_RANGE | 9,702,520 | 1.6% | 90.6% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 9,702,520 | 1.6% | 92.2% |  |
| _CHECK_STACK_SPACE | 9,702,520 | 1.6% | 93.8% |  |
| _INIT_CALL_PY_EXACT_ARGS | 9,702,520 | 1.6% | 95.3% |  |
| _PUSH_FRAME | 9,702,520 | 1.6% | 96.9% |  |
| _SAVE_RETURN_OFFSET | 9,702,520 | 1.6% | 98.4% |  |
| _COLD_EXIT | 9,702,520 | 1.6% | 100.0% |  |
