...
| Increfs | 17,615,231 | 2.8% |
| Decrefs | 20,475,270 | 3.2% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 71,165 |  |
| Method cache misses | 2,095 |  |
| Method cache collisions | 3,142 |  |
| Method cache dunder hits | 142,904 |  |
| Method cache dunder misses | 1,396 |  |
