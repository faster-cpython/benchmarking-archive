...
| Allocations | 66,929,260 | 50.4% |
| Allocations to 512 bytes | 66,920,640 | 50.4% |
...
| Increfs | 250,856,435 | 19.3% |
| Decrefs | 311,734,580 | 22.1% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 42,861,054 |  |
| Method cache misses | 16,246 |  |
| Method cache collisions | 13,241 |  |
| Method cache dunder hits | 10,974,912 |  |
