...
|---|---:|---:|---:|---:|
| LOAD_FAST | 5,031,721 | 18.6% | 18.6% |  |
| POP_JUMP_IF_FALSE | 1,499,380 | 5.5% | 24.1% |  |
| LOAD_ATTR_SLOT | 1,299,761 | 4.8% | 29.0% | 0.4% |
| LOAD_CONST | 1,175,345 | 4.3% | 33.3% |  |
| LOAD_FAST_LOAD_FAST | 1,099,224 | 4.1% | 37.4% |  |
| LOAD_GLOBAL_MODULE | 1,058,800 | 3.9% | 41.3% | 0.1% |
| STORE_FAST | 988,890 | 3.7% | 44.9% |  |
| RESUME_CHECK | 888,888 | 3.3% | 48.2% | 0.0% |
| TO_BOOL_BOOL | 850,080 | 3.1% | 51.4% |  |
| LOAD_ATTR_INSTANCE_VALUE | 830,564 | 3.1% | 54.4% | 0.1% |
| LOAD_GLOBAL_BUILTIN | 747,275 | 2.8% | 57.2% | 0.4% |
| LOAD_ATTR | 720,920 | 2.7% | 59.9% |  |
| POP_JUMP_IF_TRUE | 583,521 | 2.2% | 62.0% |  |
| POP_TOP | 565,819 | 2.1% | 64.1% |  |
| RETURN_VALUE | 519,868 | 1.9% | 66.0% |  |
| CALL_PY_EXACT_ARGS | 464,499 | 1.7% | 67.8% | 0.1% |
| IS_OP | 418,560 | 1.5% | 69.3% |  |
| RETURN_CONST | 384,369 | 1.4% | 70.7% |  |
| CALL | 359,534 | 1.3% | 72.1% |  |
| PUSH_NULL | 311,089 | 1.2% | 73.2% |  |
| JUMP_BACKWARD | 304,621 | 1.1% | 74.3% |  |
| LOAD_ATTR_MODULE | 280,159 | 1.0% | 75.4% | 0.1% |
| LOAD_ATTR_METHOD_NO_DICT | 276,586 | 1.0% | 76.4% | 0.4% |
...
| INTERPRETER_EXIT | 209,725 | 0.8% | 84.5% |  |
| CALL_LEN | 195,796 | 0.7% | 85.2% |  |
...
| NOP | 120,925 | 0.4% | 91.4% |  |
| JUMP_FORWARD | 108,862 | 0.4% | 91.8% |  |
...
| TO_BOOL | 83,426 | 0.3% | 93.8% |  |
| BINARY_SLICE | 81,536 | 0.3% | 94.1% |  |
...
| CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS | 26,023 | 0.1% | 97.9% |  |
...
| JUMP_BACKWARD_NO_INTERRUPT | 10,621 | 0.0% | 99.4% |  |
| RESUME | 10,387 | 0.0% | 99.5% | 0.0% |
...
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 805,324 | 3.0% | 6.5% |
| POP_JUMP_IF_FALSE LOAD_FAST | 784,179 | 2.9% | 9.4% |
| STORE_FAST LOAD_FAST | 729,266 | 2.7% | 12.1% |
| LOAD_FAST LOAD_ATTR | 547,809 | 2.0% | 14.2% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 511,379 | 1.9% | 16.1% |
| RESUME_CHECK LOAD_FAST | 469,164 | 1.7% | 17.8% |
| POP_JUMP_IF_TRUE LOAD_FAST | 454,002 | 1.7% | 19.5% |
| IS_OP POP_JUMP_IF_FALSE | 416,220 | 1.5% | 21.0% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 404,619 | 1.5% | 22.5% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 378,118 | 1.4% | 23.9% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 306,799 | 1.1% | 30.0% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 275,619 | 1.0% | 31.1% |
| LOAD_FAST LOAD_CONST | 261,074 | 1.0% | 32.0% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 248,019 | 0.9% | 33.0% |
...
| POP_TOP LOAD_FAST | 178,065 | 0.7% | 42.5% |
| LOAD_ATTR_MODULE PUSH_NULL | 174,321 | 0.6% | 43.2% |
| LOAD_ATTR LOAD_FAST | 173,679 | 0.6% | 43.8% |
| LOAD_ATTR_METHOD_WITH_VALUES CALL_PY_EXACT_ARGS | 169,881 | 0.6% | 44.4% |
| CACHE RESUME_CHECK | 164,603 | 0.6% | 45.1% |
...
| CALL STORE_FAST | 137,585 | 0.5% | 55.0% |
...
| POP_TOP RETURN_CONST | 109,567 | 0.4% | 59.0% |
| RETURN_CONST INTERPRETER_EXIT | 106,424 | 0.4% | 59.4% |
| LOAD_FAST_LOAD_FAST STORE_ATTR_INSTANCE_VALUE | 106,080 | 0.4% | 59.8% |
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 105,780 | 0.4% | 60.2% |
...
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 96,302 | 0.4% | 62.8% |
| NOP LOAD_FAST | 96,142 | 0.4% | 63.2% |
| POP_JUMP_IF_NONE LOAD_FAST | 93,167 | 0.3% | 63.5% |
| CALL_LEN LOAD_FAST | 92,140 | 0.3% | 63.8% |
...
| LOAD_FAST CALL | 72,556 | 0.3% | 68.3% |
...
| LOAD_CONST LOAD_CONST | 69,543 | 0.3% | 69.6% |
...
| LOAD_ATTR_INSTANCE_VALUE | 22,062 | 26.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 784,179 | 15.6% |
| STORE_FAST | 729,266 | 14.5% |
| RESUME_CHECK | 469,164 | 9.3% |
| POP_JUMP_IF_TRUE | 454,002 | 9.0% |
| LOAD_GLOBAL_BUILTIN | 404,619 | 8.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 964,961 | 19.2% |
| LOAD_ATTR_INSTANCE_VALUE | 805,324 | 16.0% |
...
| IS_OP | 416,220 | 27.8% |
| COMPARE_OP_INT | 248,019 | 16.5% |
| TO_BOOL_NONE | 75,540 | 5.0% |
| CONTAINS_OP | 65,300 | 4.4% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 784,179 | 52.3% |
| LOAD_GLOBAL_BUILTIN | 306,799 | 20.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 105,780 | 54.0% |
| LOAD_FAST | 72,716 | 37.1% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,220 | 8.1% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.2% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 248,019 | 98.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 96,302 | 34.8% |
| CALL_METHOD_DESCRIPTOR_NOARGS | 69,561 | 25.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 306,799 | 41.1% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 378,118 | 42.5% |
| CACHE | 164,603 | 18.5% |
...
|---|---:|---:|
| Basic | 13,036,877 | 48.2% |
| Not specialized | 4,447,879 | 16.4% |
| Specialized hits | 9,478,094 | 35.0% |
| Specialized misses | 83,258 | 0.3% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 210,284 | 19.8% |
| Calls to Python functions inlined | 849,112 | 80.2% |
| Calls via PyEval_EvalFrame (total) | 210,284 | 19.8% |
| Calls via PyEval_EvalFrame (vector) | 193,422 | 18.3% |
| Calls via PyEval_EvalFrame (generator) | 16,862 | 1.6% |
| Calls via PyEval_EvalFrame (legacy) | 80 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 193,062 | 18.2% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 776,702 | 32.6% |
| Frees to freelist | 780,809 |  |
| Allocations | 1,603,912 | 67.4% |
| Allocations to 512 bytes | 1,413,725 | 59.4% |
| Allocations to 4 kbytes | 132,347 | 5.6% |
| Allocations over 4 kbytes | 57,840 | 2.4% |
| Frees | 1,542,852 |  |
| New values | 34,900 |  |
| Interpreter increfs | 12,201,764 | 76.5% |
| Interpreter decrefs | 14,017,494 | 78.1% |
| Increfs | 3,738,209 | 23.5% |
| Decrefs | 3,927,614 | 21.9% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 1,218,285 |  |
| Method cache misses | 42,271 |  |
| Method cache collisions | 48,894 |  |
| Method cache dunder hits | 355,209 |  |
| Method cache dunder misses | 8,798 |  |
