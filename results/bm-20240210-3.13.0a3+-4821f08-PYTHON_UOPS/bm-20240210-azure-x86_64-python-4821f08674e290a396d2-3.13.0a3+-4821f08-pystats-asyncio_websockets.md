...
|---|---:|---:|---:|---:|
| LOAD_FAST | 3,992,011 | 18.5% | 18.5% |  |
| POP_JUMP_IF_FALSE | 1,137,951 | 5.3% | 23.8% |  |
| LOAD_CONST | 1,135,881 | 5.3% | 29.1% |  |
| RESUME_CHECK | 863,865 | 4.0% | 33.1% | 0.0% |
| LOAD_FAST_LOAD_FAST | 816,884 | 3.8% | 36.9% |  |
| LOAD_ATTR_INSTANCE_VALUE | 776,392 | 3.6% | 40.5% | 0.1% |
...
| INTERPRETER_EXIT | 209,722 | 1.0% | 79.8% |  |
| CALL_LEN | 192,372 | 0.9% | 80.7% |  |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 751,392 | 3.5% | 3.5% |
...
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 400,655 | 1.9% | 17.0% |
...
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 242,655 | 1.1% | 22.3% |
...
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 179,075 | 0.8% | 28.9% |
...
| LOAD_FAST CALL_PY_EXACT_ARGS | 138,939 | 0.6% | 42.6% |
...
| RETURN_CONST INTERPRETER_EXIT | 106,421 | 0.5% | 48.9% |
...
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 102,356 | 0.5% | 51.8% |
...
| CALL_LEN LOAD_FAST | 92,076 | 0.4% | 54.0% |
...
| LOAD_CONST LOAD_CONST | 69,541 | 0.3% | 60.9% |
...
| LOAD_GLOBAL_BUILTIN | 400,655 | 10.0% |
| LOAD_CONST | 213,300 | 5.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 751,392 | 18.8% |
...
| LOAD_GLOBAL_BUILTIN | 179,075 | 15.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 242,655 | 98.9% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 179,075 | 29.1% |
...
|---|---:|---:|
| Basic | 10,670,646 | 49.5% |
| Not specialized | 3,469,873 | 16.1% |
| Specialized hits | 7,323,768 | 34.0% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 210,282 | 20.8% |
| Calls to Python functions inlined | 801,251 | 79.2% |
| Calls via PyEval_EvalFrame (total) | 210,282 | 20.8% |
| Calls via PyEval_EvalFrame (vector) | 193,420 | 19.1% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 776,700 | 32.6% |
| Frees to freelist | 780,803 |  |
| Allocations | 1,604,314 | 67.4% |
| Allocations to 512 bytes | 1,413,932 | 59.4% |
| Allocations to 4 kbytes | 132,539 | 5.6% |
| Allocations over 4 kbytes | 57,843 | 2.4% |
| Frees | 1,542,708 |  |
| New values | 34,900 |  |
| Interpreter increfs | 12,352,250 | 76.8% |
| Interpreter decrefs | 14,167,931 | 78.3% |
| Increfs | 3,740,205 | 23.2% |
| Decrefs | 3,929,407 | 21.7% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 1,219,355 |  |
| Method cache misses | 40,778 |  |
| Method cache collisions | 49,530 |  |
| Method cache dunder hits | 352,693 |  |
| Method cache dunder misses | 11,312 |  |
