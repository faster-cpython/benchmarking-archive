...
| Increfs | 252,492,294 | 37.3% |
| Decrefs | 293,909,970 | 37.5% |
| Materialize dict (on request) | 1,040 | 35.9% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 31,994,299 |  |
| Method cache misses | 27,841 |  |
| Method cache collisions | 40,042 |  |
| Method cache dunder hits | 45,513,249 |  |
| Method cache dunder misses | 17,421 |  |
