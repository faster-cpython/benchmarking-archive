...
| Increfs | 460,485,632 | 98.9% |
| Decrefs | 641,485,323 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 4,066,177 |  |
| Method cache misses | 849,923 |  |
| Method cache collisions | 849,469 |  |
| Method cache dunder hits | 1,638,995 |  |
