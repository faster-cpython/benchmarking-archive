...
| Increfs | 3,247,853,623 | 27.0% |
| Decrefs | 3,530,647,276 | 25.5% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 120,025,920 |  |
| Method cache misses | 320 |  |
| Method cache collisions | 347 |  |
| Method cache dunder hits | 1,320,054,940 |  |
