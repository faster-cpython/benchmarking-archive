...
- [📈time plot](bm-20240423-linux-x86_64-brandtbucher-justin_ghccc_perf-3.13.0a6%2B-f7a4afd-vs-3.10.4.png)

### vs. 3.11.0

- Geometric mean: 1.07x faster (HPT: reliability of 96.41%, 1.00x faster at 99th %ile)
- Memory usage: 1.10x
- missing benchmarks: flaskblogging, sqlalchemy_declarative, sqlalchemy_imperative, unpack_sequence
- [📄table](bm-20240423-linux-x86_64-brandtbucher-justin_ghccc_perf-3.13.0a6%2B-f7a4afd-vs-3.11.0.md)
- [📈time plot](bm-20240423-linux-x86_64-brandtbucher-justin_ghccc_perf-3.13.0a6%2B-f7a4afd-vs-3.11.0.png)
...
- [📈time plot](bm-20240423-linux-x86_64-brandtbucher-justin_ghccc_perf-3.13.0a6%2B-f7a4afd-vs-3.12.0.png)

### vs. base

- Geometric mean: 1.01x faster (HPT: reliability of 100.00%, 1.00x faster at 99th %ile)
- Memory usage: 1.00x
- [🧠memory plot](bm-20240423-linux-x86_64-brandtbucher-justin_ghccc_perf-3.13.0a6%2B-f7a4afd-vs-base-mem.png)
- [📄table](bm-20240423-linux-x86_64-brandtbucher-justin_ghccc_perf-3.13.0a6%2B-f7a4afd-vs-base.md)
- [📈time plot](bm-20240423-linux-x86_64-brandtbucher-justin_ghccc_perf-3.13.0a6%2B-f7a4afd-vs-base.png)
