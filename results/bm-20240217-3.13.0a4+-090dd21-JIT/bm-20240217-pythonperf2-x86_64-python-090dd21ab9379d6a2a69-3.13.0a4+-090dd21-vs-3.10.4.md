...
| unpickle_pure_python     | 312 us                                                       | 232 us: 1.34x faster                                                         |
| unpack_sequence          | 59.9 ns                                                      | 44.7 ns: 1.34x faster                                                        |
...
| pyflate                  | 733 ms                                                       | 551 ms: 1.33x faster                                                         |
| xml_etree_process        | 75.9 ms                                                      | 57.6 ms: 1.32x faster                                                        |
...
| hexiom                   | 9.42 ms                                                      | 7.62 ms: 1.24x faster                                                        |
...
| xml_etree_iterparse      | 110 ms                                                       | 103 ms: 1.07x faster                                                         |
| mypy2                    | 933 ms                                                       | 884 ms: 1.06x faster                                                         |
| regex_dna                | 261 ms                                                       | 248 ms: 1.05x faster                                                         |
...
Ignored benchmarks (4) of results/bm-20240217-3.13.0a4+-090dd21-JIT/bm-20240217-pythonperf2-x86_64-python-090dd21ab9379d6a2a69-3.13.0a4+-090dd21.json: async_tree_cpu_io_mixed_tg, async_tree_io_tg, async_tree_memoization_tg, async_tree_none_tg
