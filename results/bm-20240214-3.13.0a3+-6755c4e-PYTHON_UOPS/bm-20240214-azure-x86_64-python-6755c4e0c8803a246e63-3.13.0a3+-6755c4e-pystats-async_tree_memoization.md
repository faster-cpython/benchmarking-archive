...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 45,910,460 | 23.1% |
|          hit | 152,352,600 | 76.8% |
|         miss | 4,565,360 | 2.3% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 35,019,220 | 11.7% |
|          hit | 263,190,080 | 88.2% |
|         miss | 688,080 | 0.2% |
...
| Specialized hits | 873,303,540 | 35.8% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 51,108,820 | 37.8% |
| Calls to Python functions inlined | 83,976,800 | 62.2% |
| Calls via PyEval_EvalFrame (total) | 51,108,820 | 37.8% |
| Calls via PyEval_EvalFrame (vector) | 45,511,080 | 33.7% |
| Calls via PyEval_EvalFrame (generator) | 5,597,740 | 4.1% |
| Calls via PyEval_EvalFrame (legacy) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 45,511,080 | 33.7% |
...
| Calls via PyEval_EvalFrame (method) | 20,153,400 | 14.9% |
| Frame objects created | 180 | 0.0% |
| Frames pushed | 78,378,260 | 58.0% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 64,061,606 | 36.8% |
| Frees to freelist | 64,521,489 |  |
| Allocations | 110,120,194 | 63.2% |
| Allocations to 512 bytes | 110,058,134 | 63.2% |
| Allocations to 4 kbytes | 61,930 | 0.0% |
| Allocations over 4 kbytes | 130 | 0.0% |
| Frees | 112,222,616 |  |
| New values | 420 |  |
| Interpreter increfs | 1,383,548,220 | 78.8% |
| Interpreter decrefs | 1,447,425,542 | 75.9% |
| Increfs | 371,180,176 | 21.2% |
| Decrefs | 459,036,181 | 24.1% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 93,971,026 |  |
| Method cache misses | 1,383,194 |  |
| Method cache collisions | 1,378,454 |  |
| Method cache dunder hits | 15,655,475 |  |
| Method cache dunder misses | 585 |  |
...
|---:|---:|---:|---:|
| 0 | 53,339 | 2,040 | 367,149,248 |
| 1 | 4,840 | 0 | 373,335,142 |
| 2 | 440 | 0 | 903,252,304 |
...
| Traces executed | 19,634,740 |  |
| Uops executed | 781,259,380 | 39.79 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 97,727,860 | 12.5% | 12.5% |  |
| _GUARD_TYPE_VERSION | 84,316,440 | 10.8% | 23.3% | 0.4% |
| _SET_IP | 74,706,940 | 9.6% | 32.9% |  |
| _CHECK_VALIDITY | 74,705,140 | 9.6% | 42.4% |  |
| _LOAD_ATTR_SLOT | 40,670,220 | 5.2% | 47.6% |  |
| _CHECK_VALIDITY_AND_SET_IP | 34,328,160 | 4.4% | 52.0% |  |
| STORE_FAST | 29,330,480 | 3.8% | 55.8% |  |
| _GUARD_IS_FALSE_POP | 24,481,940 | 3.1% | 58.9% | 0.2% |
| TO_BOOL_BOOL | 23,881,280 | 3.1% | 62.0% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 22,008,820 | 2.8% | 64.8% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 22,008,820 | 2.8% | 67.6% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 20,893,280 | 2.7% | 70.3% |  |
| _EXIT_TRACE | 17,717,460 | 2.3% | 72.5% | 100.0% |
| _LOAD_ATTR | 17,538,820 | 2.2% | 74.8% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 14,179,000 | 1.8% | 76.6% |  |
| PUSH_NULL | 10,675,160 | 1.4% | 78.0% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 10,448,680 | 1.3% | 79.3% | 0.0% |
| _ITER_CHECK_RANGE | 10,448,680 | 1.3% | 80.6% |  |
| _ITER_NEXT_RANGE | 10,446,880 | 1.3% | 82.0% |  |
| BUILD_LIST | 10,074,580 | 1.3% | 83.3% |  |
| CALL_INTRINSIC_1 | 10,074,580 | 1.3% | 84.6% |  |
| LIST_EXTEND | 10,074,580 | 1.3% | 85.9% |  |
| RESUME_CHECK | 10,074,580 | 1.3% | 87.1% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 10,074,580 | 1.3% | 88.4% |  |
| _CHECK_STACK_SPACE | 10,074,580 | 1.3% | 89.7% |  |
| _INIT_CALL_PY_EXACT_ARGS | 10,074,580 | 1.3% | 91.0% |  |
| _PUSH_FRAME | 10,074,580 | 1.3% | 92.3% |  |
| _SAVE_RETURN_OFFSET | 10,074,580 | 1.3% | 93.6% |  |
| _GUARD_NOT_EXHAUSTED_TUPLE | 4,478,580 | 0.6% | 94.2% | 16.7% |
| _ITER_CHECK_TUPLE | 4,478,580 | 0.6% | 94.7% |  |
| _GUARD_NOT_EXHAUSTED_LIST | 4,478,560 | 0.6% | 95.3% | 16.7% |
| _ITER_CHECK_LIST | 4,478,560 | 0.6% | 95.9% |  |
| _GUARD_IS_TRUE_POP | 4,103,940 | 0.5% | 96.4% | 0.0% |
| _LOAD_CONST_INLINE | 4,103,940 | 0.5% | 96.9% |  |
| _CHECK_GLOBALS | 4,103,940 | 0.5% | 97.5% |  |
| CONTAINS_OP | 3,732,120 | 0.5% | 97.9% |  |
| _ITER_NEXT_LIST | 3,732,120 | 0.5% | 98.4% |  |
| _ITER_NEXT_TUPLE | 3,732,120 | 0.5% | 98.9% |  |
| _LOAD_CONST_INLINE_WITH_NULL | 3,732,120 | 0.5% | 99.4% |  |
| _LOAD_CONST_INLINE_BORROW | 743,720 | 0.1% | 99.5% |  |
| CALL_BUILTIN_O | 600,580 | 0.1% | 99.5% |  |
| BINARY_SUBSCR_LIST_INT | 371,900 | 0.0% | 99.6% |  |
| COMPARE_OP_FLOAT | 371,900 | 0.0% | 99.6% |  |
