...
| Increfs | 940,679,696 | 52.8% |
| Decrefs | 1,047,503,746 | 50.3% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 154,261,830 |  |
| Method cache misses | 78,830 |  |
| Method cache collisions | 385,166 |  |
| Method cache dunder hits | 57,225,319 |  |
| Method cache dunder misses | 318,761 |  |
...
| Uops executed | 1,387,326,540 | 25.62 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 210,373,100 | 15.2% | 15.2% |  |
| _SET_IP | 164,753,440 | 11.9% | 27.0% |  |
| _CHECK_VALIDITY | 142,558,860 | 10.3% | 37.3% |  |
| STORE_FAST | 96,955,620 | 7.0% | 44.3% |  |
| _CHECK_VALIDITY_AND_SET_IP | 88,566,700 | 6.4% | 50.7% |  |
| _LOAD_CONST_INLINE_WITH_NULL | 49,559,160 | 3.6% | 54.3% |  |
| _LOAD_CONST_INLINE_BORROW | 49,526,660 | 3.6% | 57.8% |  |
| _FOR_ITER_TIER_TWO | 46,644,240 | 3.4% | 61.2% | 0.5% |
| _EXIT_TRACE | 42,293,100 | 3.0% | 64.2% | 100.0% |
| _GUARD_IS_FALSE_POP | 39,128,200 | 2.8% | 67.1% | 0.3% |
| CALL_ISINSTANCE | 38,319,520 | 2.8% | 69.8% |  |
| TO_BOOL_BOOL | 38,319,520 | 2.8% | 72.6% |  |
| _CHECK_GLOBALS | 38,156,760 | 2.8% | 75.3% |  |
| _LOAD_ATTR | 28,545,620 | 2.1% | 77.4% |  |
| _CHECK_BUILTINS | 27,732,420 | 2.0% | 79.4% |  |
| _GUARD_TYPE_VERSION | 27,691,280 | 2.0% | 81.4% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 27,675,360 | 2.0% | 83.4% |  |
| _LOAD_CONST_INLINE | 27,485,000 | 2.0% | 85.4% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 26,812,480 | 1.9% | 87.3% |  |
| BUILD_TUPLE | 21,870,080 | 1.6% | 88.9% |  |
| UNPACK_SEQUENCE_TWO_TUPLE | 17,127,440 | 1.2% | 90.1% |  |
| _JUMP_TO_TOP | 16,328,420 | 1.2% | 91.3% |  |
| LIST_APPEND | 16,328,000 | 1.2% | 92.5% |  |
| _GUARD_IS_TRUE_POP | 12,305,780 | 0.9% | 93.3% |  |
| _GUARD_NOT_EXHAUSTED_LIST | 12,302,800 | 0.9% | 94.2% | 93.4% |
| _ITER_CHECK_LIST | 12,302,800 | 0.9% | 95.1% |  |
| LOAD_DEREF | 12,218,260 | 0.9% | 96.0% |  |
| CONTAINS_OP | 11,403,460 | 0.8% | 96.8% |  |
| GET_ITER | 10,499,200 | 0.8% | 97.6% |  |
| PUSH_NULL | 6,478,240 | 0.5% | 98.0% |  |
