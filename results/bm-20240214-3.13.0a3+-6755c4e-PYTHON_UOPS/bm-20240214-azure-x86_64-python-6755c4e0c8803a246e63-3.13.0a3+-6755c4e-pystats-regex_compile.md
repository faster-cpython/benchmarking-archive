...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 9,244,080 | 26.4% |
| Calls to Python functions inlined | 25,735,520 | 73.6% |
| Calls via PyEval_EvalFrame (total) | 9,244,080 | 26.4% |
| Calls via PyEval_EvalFrame (vector) | 9,244,080 | 26.4% |
| Calls via PyEval_EvalFrame (generator) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (legacy) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 9,244,080 | 26.4% |
| Calls via PyEval_EvalFrame (build class) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (slot) | 7,649,360 | 21.9% |
| Calls via PyEval_EvalFrame (function ex) | 160 | 0.0% |
| Calls via PyEval_EvalFrame (api) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (method) | 0 | 0.0% |
| Frame objects created | 3,072,080 | 8.8% |
| Frames pushed | 32,422,200 | 92.7% |
...
| Interpreter increfs | 565,419,000 | 84.7% |
| Interpreter decrefs | 612,067,540 | 82.6% |
| Increfs | 101,839,402 | 15.3% |
| Decrefs | 129,370,747 | 17.4% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 8,151,136 |  |
| Method cache misses | 56,044 |  |
| Method cache collisions | 112,023 |  |
| Method cache dunder hits | 20,326,349 |  |
| Method cache dunder misses | 55,991 |  |
...
| Traces executed | 18,020,080 |  |
| Uops executed | 808,939,620 | 44.89 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 134,120,860 | 16.6% | 16.6% |  |
| _SET_IP | 94,398,020 | 11.7% | 28.2% |  |
| _CHECK_VALIDITY | 85,978,900 | 10.6% | 38.9% |  |
| STORE_FAST | 52,989,520 | 6.6% | 45.4% |  |
| _LOAD_CONST_INLINE_BORROW | 38,215,000 | 4.7% | 50.2% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 31,134,880 | 3.8% | 54.0% | 4.5% |
| _ITER_CHECK_RANGE | 31,134,880 | 3.8% | 57.9% |  |
| _ITER_NEXT_RANGE | 29,744,640 | 3.7% | 61.5% |  |
| _JUMP_TO_TOP | 28,992,320 | 3.6% | 65.1% |  |
| _STORE_SUBSCR | 27,077,000 | 3.3% | 68.5% |  |
| _GUARD_TYPE_VERSION | 18,869,300 | 2.3% | 70.8% |  |
| _LOAD_CONST_INLINE | 16,469,740 | 2.0% | 72.8% |  |
| _GUARD_IS_FALSE_POP | 16,310,520 | 2.0% | 74.8% | 22.2% |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 11,117,700 | 1.4% | 76.2% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 11,117,700 | 1.4% | 77.6% |  |
| _ITER_CHECK_LIST | 10,576,020 | 1.3% | 78.9% | 21.6% |
| _GUARD_NOT_EXHAUSTED_LIST | 8,289,540 | 1.0% | 79.9% | 25.6% |
| IS_OP | 8,094,520 | 1.0% | 80.9% |  |
| CONTAINS_OP | 7,181,880 | 0.9% | 81.8% |  |
| POP_TOP | 6,205,080 | 0.8% | 82.6% |  |
| _ITER_NEXT_LIST | 6,164,380 | 0.8% | 83.3% |  |
| _CHECK_VALIDITY_AND_SET_IP | 6,104,620 | 0.8% | 84.1% |  |
| RESUME_CHECK | 6,073,840 | 0.8% | 84.8% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 6,073,840 | 0.8% | 85.6% |  |
| _CHECK_STACK_SPACE | 6,073,840 | 0.8% | 86.3% |  |
| _INIT_CALL_PY_EXACT_ARGS | 6,073,840 | 0.8% | 87.1% |  |
| _PUSH_FRAME | 6,073,840 | 0.8% | 87.9% |  |
| _SAVE_RETURN_OFFSET | 6,073,840 | 0.8% | 88.6% |  |
| _CHECK_GLOBALS | 6,025,400 | 0.7% | 89.3% |  |
| PUSH_NULL | 5,692,480 | 0.7% | 90.0% |  |
| _EXIT_TRACE | 5,069,060 | 0.6% | 90.7% | 100.0% |
| _GUARD_IS_TRUE_POP | 5,018,440 | 0.6% | 91.3% | 45.6% |
| _GUARD_BOTH_INT | 4,789,080 | 0.6% | 91.9% |  |
| _POP_FRAME | 4,786,520 | 0.6% | 92.5% |  |
| UNPACK_SEQUENCE_TWO_TUPLE | 4,613,220 | 0.6% | 93.1% |  |
| _GUARD_DORV_VALUES | 4,443,920 | 0.5% | 93.6% |  |
| _STORE_ATTR_INSTANCE_VALUE | 4,443,920 | 0.5% | 94.1% |  |
| _BINARY_OP_ADD_INT | 3,958,280 | 0.5% | 94.6% |  |
| _GUARD_IS_NOT_NONE_POP | 3,719,380 | 0.5% | 95.1% | 6.0% |
| TO_BOOL_INT | 3,323,240 | 0.4% | 95.5% |  |
| BINARY_SUBSCR_STR_INT | 2,519,440 | 0.3% | 95.8% | 3.9% |
| _CHECK_CALL_BOUND_METHOD_EXACT_ARGS | 2,491,680 | 0.3% | 96.1% |  |
| _INIT_CALL_BOUND_METHOD_EXACT_ARGS | 2,491,680 | 0.3% | 96.4% |  |
| COMPARE_OP_STR | 2,487,120 | 0.3% | 96.7% |  |
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 2,483,000 | 0.3% | 97.1% |  |
| _GUARD_KEYS_VERSION | 2,483,000 | 0.3% | 97.4% |  |
| _LOAD_ATTR_METHOD_WITH_VALUES | 2,483,000 | 0.3% | 97.7% |  |
| _LOAD_CONST_INLINE_WITH_NULL | 1,611,800 | 0.2% | 97.9% |  |
| _BINARY_OP_SUBTRACT_INT | 1,290,880 | 0.2% | 98.0% |  |
| TO_BOOL_BOOL | 1,257,760 | 0.2% | 98.2% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 1,023,360 | 0.1% | 98.3% |  |
| STORE_SUBSCR_LIST_INT | 1,016,380 | 0.1% | 98.4% |  |
| _TO_BOOL | 979,300 | 0.1% | 98.6% |  |
| CALL_LEN | 846,400 | 0.1% | 98.7% |  |
...
| _LOAD_ATTR_MODULE | 682,240 | 0.1% | 99.1% |  |
| BINARY_SUBSCR_DICT | 620,380 | 0.1% | 99.2% |  |
| CALL_BUILTIN_O | 607,360 | 0.1% | 99.3% |  |
| _FOR_ITER_TIER_TWO | 606,880 | 0.1% | 99.4% | 62.4% |
| _BINARY_OP | 597,760 | 0.1% | 99.4% |  |
...
| BINARY_SUBSCR_TUPLE_INT | 12,360 | 0.0% | 100.0% |  |
