...
| Allocations | 40,841,048 | 69.7% |
| Allocations to 512 bytes | 40,076,628 | 68.4% |
...
| Increfs | 42,091,720 | 14.9% |
| Decrefs | 72,823,443 | 21.2% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 2,758,569 |  |
| Method cache misses | 255,411 |  |
| Method cache collisions | 308,379 |  |
| Method cache dunder hits | 2,944,043 |  |
| Method cache dunder misses | 57,277 |  |
...
| Uops executed | 72,436,300 | 28.68 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 12,371,880 | 17.1% | 17.1% |  |
| _SET_IP | 11,001,660 | 15.2% | 32.3% |  |
| _CHECK_VALIDITY | 5,908,420 | 8.2% | 40.4% |  |
| STORE_FAST | 4,389,760 | 6.1% | 46.5% |  |
| _LOAD_CONST_INLINE_BORROW | 3,642,860 | 5.0% | 51.5% |  |
| _GUARD_TYPE_VERSION | 2,970,940 | 4.1% | 55.6% |  |
| _BINARY_OP_ADD_INT | 2,888,180 | 4.0% | 59.6% |  |
| _GUARD_BOTH_INT | 2,883,340 | 4.0% | 63.6% |  |
| _FOR_ITER_TIER_TWO | 1,748,860 | 2.4% | 66.0% | 28.5% |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 1,707,980 | 2.4% | 68.4% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 1,707,980 | 2.4% | 70.7% |  |
| _EXIT_TRACE | 1,262,540 | 1.7% | 72.5% | 100.0% |
| _LOAD_ATTR_METHOD_NO_DICT | 1,258,000 | 1.7% | 74.2% |  |
| _GUARD_IS_TRUE_POP | 1,177,780 | 1.6% | 75.8% | 44.1% |
| _CHECK_VALIDITY_AND_SET_IP | 1,103,140 | 1.5% | 77.3% |  |
| BINARY_SLICE | 1,102,800 | 1.5% | 78.9% |  |
| PUSH_NULL | 1,102,780 | 1.5% | 80.4% |  |
| _LOAD_CONST_INLINE | 1,012,440 | 1.4% | 81.8% |  |
| _BINARY_OP_MULTIPLY_INT | 857,880 | 1.2% | 83.0% |  |
| RESUME_CHECK | 853,280 | 1.2% | 84.1% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 853,280 | 1.2% | 85.3% |  |
| _CHECK_STACK_SPACE | 853,280 | 1.2% | 86.5% |  |
| _INIT_CALL_PY_EXACT_ARGS | 853,280 | 1.2% | 87.7% |  |
| _PUSH_FRAME | 853,280 | 1.2% | 88.9% |  |
| _SAVE_RETURN_OFFSET | 853,280 | 1.2% | 90.0% |  |
| _BINARY_OP | 848,740 | 1.2% | 91.2% |  |
| _POP_FRAME | 848,320 | 1.2% | 92.4% |  |
| _COMPARE_OP | 848,320 | 1.2% | 93.6% |  |
| _CHECK_CALL_BOUND_METHOD_EXACT_ARGS | 848,320 | 1.2% | 94.7% |  |
| _INIT_CALL_BOUND_METHOD_EXACT_ARGS | 848,320 | 1.2% | 95.9% |  |
| _JUMP_TO_TOP | 577,000 | 0.8% | 96.7% |  |
| COMPARE_OP_INT | 329,280 | 0.5% | 97.1% |  |
| _CHECK_GLOBALS | 255,240 | 0.4% | 97.5% |  |
| CALL_BUILTIN_FAST | 254,940 | 0.4% | 97.8% |  |
| _LOAD_CONST_INLINE_WITH_NULL | 250,780 | 0.3% | 98.2% |  |
| _CHECK_BUILTINS | 250,180 | 0.3% | 98.5% |  |
