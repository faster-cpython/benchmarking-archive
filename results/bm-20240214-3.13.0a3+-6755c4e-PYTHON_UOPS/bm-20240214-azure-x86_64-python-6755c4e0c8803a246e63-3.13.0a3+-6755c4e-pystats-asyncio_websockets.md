...
|---|---:|---:|---:|---:|
| LOAD_FAST | 3,993,099 | 18.5% | 18.5% |  |
| POP_JUMP_IF_FALSE | 1,138,179 | 5.3% | 23.8% |  |
| LOAD_CONST | 1,135,891 | 5.3% | 29.1% |  |
| RESUME_CHECK | 863,871 | 4.0% | 33.1% | 0.0% |
| LOAD_FAST_LOAD_FAST | 816,884 | 3.8% | 36.9% |  |
| LOAD_ATTR_INSTANCE_VALUE | 776,848 | 3.6% | 40.5% | 0.1% |
| LOAD_GLOBAL_MODULE | 750,264 | 3.5% | 44.0% | 0.1% |
| STORE_FAST | 736,631 | 3.4% | 47.4% |  |
| LOAD_ATTR | 663,477 | 3.1% | 50.5% |  |
| TO_BOOL_BOOL | 641,278 | 3.0% | 53.4% |  |
| LOAD_GLOBAL_BUILTIN | 616,216 | 2.9% | 56.3% | 0.4% |
| POP_TOP | 565,786 | 2.6% | 58.9% |  |
| RETURN_VALUE | 519,848 | 2.4% | 61.3% |  |
| CALL_PY_EXACT_ARGS | 416,920 | 1.9% | 63.3% | 0.1% |
| RETURN_CONST | 384,196 | 1.8% | 65.0% |  |
| CALL | 359,540 | 1.7% | 66.7% |  |
| LOAD_ATTR_SLOT | 358,641 | 1.7% | 68.4% | 1.4% |
| PUSH_NULL | 289,972 | 1.3% | 69.7% |  |
| LOAD_ATTR_MODULE | 279,719 | 1.3% | 71.0% | 0.1% |
| LOAD_ATTR_METHOD_WITH_VALUES | 266,662 | 1.2% | 72.3% | 0.0% |
| POP_JUMP_IF_TRUE | 261,202 | 1.2% | 73.5% |  |
| COMPARE_OP_INT | 245,556 | 1.1% | 74.6% | 0.1% |
...
| TO_BOOL | 81,248 | 0.4% | 92.8% |  |
| CALL_METHOD_DESCRIPTOR_O | 78,962 | 0.4% | 93.1% | 1.0% |
...
| CALL_BOUND_METHOD_EXACT_ARGS | 51,980 | 0.2% | 95.5% | 19.1% |
...
| CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS | 26,024 | 0.1% | 97.3% |  |
...
| JUMP_BACKWARD_NO_INTERRUPT | 10,622 | 0.0% | 99.1% |  |
| FOR_ITER_RANGE | 10,480 | 0.0% | 99.1% |  |
| RESUME | 10,387 | 0.0% | 99.2% | 0.0% |
...
|---|---:|---:|---:|
| LOAD_FAST LOAD_ATTR_INSTANCE_VALUE | 751,848 | 3.5% | 3.5% |
| POP_JUMP_IF_FALSE LOAD_FAST | 561,597 | 2.6% | 6.1% |
| LOAD_FAST LOAD_ATTR | 516,866 | 2.4% | 8.5% |
| STORE_FAST LOAD_FAST | 498,305 | 2.3% | 10.8% |
| RESUME_CHECK LOAD_FAST | 467,066 | 2.2% | 13.0% |
| TO_BOOL_BOOL POP_JUMP_IF_FALSE | 461,996 | 2.1% | 15.1% |
| LOAD_GLOBAL_BUILTIN LOAD_FAST | 401,079 | 1.9% | 17.0% |
| CALL_PY_EXACT_ARGS RESUME_CHECK | 353,179 | 1.6% | 18.6% |
| LOAD_FAST LOAD_ATTR_SLOT | 281,521 | 1.3% | 19.9% |
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 275,179 | 1.3% | 21.2% |
| COMPARE_OP_INT POP_JUMP_IF_FALSE | 242,879 | 1.1% | 22.3% |
...
| RETURN_CONST POP_TOP | 179,368 | 0.8% | 27.2% |
| POP_JUMP_IF_FALSE LOAD_GLOBAL_BUILTIN | 179,299 | 0.8% | 28.1% |
| LOAD_FAST LOAD_ATTR_METHOD_WITH_VALUES | 179,262 | 0.8% | 28.9% |
| POP_TOP LOAD_FAST | 178,047 | 0.8% | 29.7% |
| LOAD_ATTR_MODULE PUSH_NULL | 173,921 | 0.8% | 30.5% |
| LOAD_ATTR LOAD_FAST | 173,319 | 0.8% | 31.3% |
| TO_BOOL_BOOL POP_JUMP_IF_TRUE | 170,382 | 0.8% | 32.1% |
| LOAD_ATTR_METHOD_WITH_VALUES CALL_PY_EXACT_ARGS | 166,442 | 0.8% | 32.9% |
| POP_JUMP_IF_TRUE LOAD_FAST | 165,583 | 0.8% | 33.7% |
| CACHE RESUME_CHECK | 164,605 | 0.8% | 34.4% |
...
| RESUME_CHECK LOAD_GLOBAL_MODULE | 139,102 | 0.6% | 42.0% |
| LOAD_FAST CALL_PY_EXACT_ARGS | 138,939 | 0.6% | 42.7% |
| CALL STORE_FAST | 137,588 | 0.6% | 43.3% |
...
| POP_TOP RETURN_CONST | 109,572 | 0.5% | 48.4% |
| RETURN_CONST INTERPRETER_EXIT | 106,427 | 0.5% | 48.9% |
...
| LOAD_ATTR_INSTANCE_VALUE CALL_LEN | 102,580 | 0.5% | 51.8% |
| RETURN_VALUE RETURN_VALUE | 98,961 | 0.5% | 52.3% |
| LOAD_FAST_LOAD_FAST STORE_ATTR_SLOT | 98,480 | 0.5% | 52.7% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 96,243 | 0.4% | 53.2% |
| POP_JUMP_IF_NONE LOAD_FAST | 93,172 | 0.4% | 53.6% |
| CALL_LEN LOAD_FAST | 92,300 | 0.4% | 54.0% |
...
| LOAD_FAST PUSH_NULL | 63,267 | 0.3% | 64.6% |
...
| LOAD_FAST CALL_METHOD_DESCRIPTOR_O | 57,282 | 0.3% | 66.6% |
...
| JUMP_BACKWARD_NO_INTERRUPT | 542 | 17.8% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| RETURN_CONST | 179,368 | 31.7% |
| SEND_GEN | 147,080 | 26.0% |
| END_SEND | 79,440 | 14.0% |
| CALL_METHOD_DESCRIPTOR_O | 75,302 | 13.3% |
| CALL_FUNCTION_EX | 24,800 | 4.4% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 178,047 | 31.5% |
...
| LOAD_ATTR_INSTANCE_VALUE | 19,944 | 24.5% |
| LOAD_ATTR_SLOT | 8,320 | 10.2% |
| CALL | 1,960 | 2.4% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 40,606 | 50.0% |
...
| PUSH_NULL | 31,406 | 8.7% |

|Successors | Count | Percentage | 
|---|---:|---:|
| STORE_FAST | 137,588 | 38.3% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 561,597 | 14.1% |
| STORE_FAST | 498,305 | 12.5% |
| RESUME_CHECK | 467,066 | 11.7% |
| LOAD_GLOBAL_BUILTIN | 401,079 | 10.0% |
| LOAD_CONST | 213,302 | 5.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 751,848 | 18.8% |
| LOAD_ATTR | 516,866 | 12.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 561,597 | 49.3% |
| LOAD_GLOBAL_BUILTIN | 179,299 | 15.8% |
...
| LOAD_FAST | 44,490 | 26.8% |
| LOAD_DEREF | 9,120 | 5.5% |
| LOAD_ATTR | 720 | 0.4% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 93,172 | 56.2% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_TOP | 179,368 | 46.7% |
| INTERPRETER_EXIT | 106,427 | 27.7% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 498,305 | 67.6% |
| LOAD_GLOBAL_BUILTIN | 43,998 | 6.0% |
| LOAD_GLOBAL_MODULE | 40,482 | 5.5% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_INSTANCE_VALUE | 102,580 | 53.3% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_METHOD_WITH_VALUES | 166,442 | 39.9% |
...
| LOAD_ATTR_INSTANCE_VALUE | 20,380 | 8.3% |
| LOAD_ATTR_WITH_HINT | 8,160 | 3.3% |
| LOAD_FAST_LOAD_FAST | 8,140 | 3.3% |

|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 242,879 | 98.9% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 166,442 | 62.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| CALL_PY_EXACT_ARGS | 353,179 | 40.9% |
| CACHE | 164,605 | 19.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_FAST | 467,066 | 54.1% |
| LOAD_GLOBAL_BUILTIN | 146,800 | 17.0% |
| LOAD_GLOBAL_MODULE | 139,102 | 16.1% |
...
|Successors | Count | Percentage | 
|---|---:|---:|
| POP_JUMP_IF_FALSE | 461,996 | 72.0% |
| POP_JUMP_IF_TRUE | 170,382 | 26.6% |
| UNARY_NOT | 8,800 | 1.4% |
...
|---|---:|---:|
| Basic | 10,671,952 | 49.5% |
| Not specialized | 3,470,529 | 16.1% |
| Specialized hits | 7,326,123 | 34.0% |
| Specialized misses | 83,260 | 0.4% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 210,286 | 20.8% |
| Calls to Python functions inlined | 801,453 | 79.2% |
| Calls via PyEval_EvalFrame (total) | 210,286 | 20.8% |
| Calls via PyEval_EvalFrame (vector) | 193,424 | 19.1% |
| Calls via PyEval_EvalFrame (generator) | 16,862 | 1.7% |
| Calls via PyEval_EvalFrame (legacy) | 80 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 193,064 | 19.1% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 776,705 | 32.6% |
| Frees to freelist | 780,816 |  |
| Allocations | 1,604,555 | 67.4% |
| Allocations to 512 bytes | 1,414,165 | 59.4% |
| Allocations to 4 kbytes | 132,553 | 5.6% |
| Allocations over 4 kbytes | 57,837 | 2.4% |
| Frees | 1,543,078 |  |
| New values | 34,900 |  |
| Interpreter increfs | 12,353,237 | 76.8% |
| Interpreter decrefs | 14,169,130 | 78.3% |
| Increfs | 3,739,697 | 23.2% |
| Decrefs | 3,929,232 | 21.7% |
| Materialize dict (on request) | 20 | 0.1% |
| Materialize dict (new key) | 160 | 0.5% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 1,215,154 |  |
| Method cache misses | 44,985 |  |
| Method cache collisions | 55,444 |  |
| Method cache dunder hits | 351,222 |  |
| Method cache dunder misses | 12,788 |  |
...
| Traces executed | 150,621 |  |
| Uops executed | 9,435,892 | 62.65 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 1,611,563 | 17.1% | 17.1% |  |
| _GUARD_TYPE_VERSION | 1,041,360 | 11.0% | 28.1% |  |
| _LOAD_ATTR_SLOT | 941,120 | 10.0% | 38.1% |  |
| _SET_IP | 904,864 | 9.6% | 47.7% |  |
| _CHECK_VALIDITY | 834,926 | 8.8% | 56.5% |  |
| _GUARD_IS_TRUE_POP | 343,863 | 3.6% | 60.2% | 9.7% |
| _GUARD_IS_FALSE_POP | 339,820 | 3.6% | 63.8% | 0.2% |
| _LOAD_CONST_INLINE | 303,260 | 3.2% | 67.0% |  |
| IS_OP | 287,040 | 3.0% | 70.0% |  |
| STORE_FAST | 263,303 | 2.8% | 72.8% |  |
| TO_BOOL_BOOL | 208,803 | 2.2% | 75.0% |  |
| _FOR_ITER_TIER_TWO | 200,741 | 2.1% | 77.2% | 20.3% |
| _CHECK_GLOBALS | 180,900 | 1.9% | 79.1% |  |
| CONTAINS_OP | 177,320 | 1.9% | 81.0% |  |
| _LOAD_CONST_INLINE_WITH_NULL | 140,460 | 1.5% | 82.4% |  |
| _JUMP_TO_TOP | 140,200 | 1.5% | 83.9% |  |
| _CHECK_BUILTINS | 131,040 | 1.4% | 85.3% |  |
| CALL_BUILTIN_FAST | 127,500 | 1.4% | 86.7% |  |
| STORE_SUBSCR_DICT | 127,500 | 1.4% | 88.0% |  |
| _CHECK_VALIDITY_AND_SET_IP | 109,023 | 1.2% | 89.2% |  |
| _EXIT_TRACE | 61,460 | 0.7% | 89.8% | 100.0% |
| _LOAD_ATTR | 57,023 | 0.6% | 90.4% |  |
...
| _CHECK_FUNCTION_EXACT_ARGS | 47,660 | 0.5% | 93.1% |  |
| _CHECK_STACK_SPACE | 47,660 | 0.5% | 93.6% |  |
| _INIT_CALL_PY_EXACT_ARGS | 47,660 | 0.5% | 94.1% |  |
| _PUSH_FRAME | 47,660 | 0.5% | 94.6% |  |
| _SAVE_RETURN_OFFSET | 47,660 | 0.5% | 95.2% |  |
| _ITER_NEXT_RANGE | 45,760 | 0.5% | 95.6% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 40,300 | 0.4% | 96.1% |  |
| _LOAD_CONST_INLINE_BORROW | 35,520 | 0.4% | 96.4% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 27,123 | 0.3% | 96.7% |  |
| RESUME_CHECK | 25,020 | 0.3% | 97.0% |  |
...
| _GUARD_NOT_EXHAUSTED_LIST | 18,820 | 0.2% | 98.3% | 49.5% |
| _ITER_CHECK_LIST | 18,820 | 0.2% | 98.5% |  |
...
| _BINARY_OP | 10,080 | 0.1% | 99.0% |  |
| BINARY_SUBSCR_DICT | 10,000 | 0.1% | 99.1% |  |
| _STORE_SUBSCR | 10,000 | 0.1% | 99.2% |  |
| _ITER_NEXT_LIST | 9,500 | 0.1% | 99.3% |  |
| _ITER_NEXT_TUPLE | 9,000 | 0.1% | 99.4% |  |
