...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 8,705,720 | 19.4% |
|          hit | 35,972,800 | 80.3% |
|         miss | 6,766,920 | 15.1% |

| | Count | Ratio | 
|---|---:|---:|
| Success | 134,500 | 97.6% |
| Failure | 3,280 | 2.4% |
...
| Not specialized | 99,192,940 | 11.3% |
| Specialized hits | 330,203,020 | 37.6% |
| Specialized misses | 6,944,540 | 0.8% |
...
| Calls to Python functions inlined | 29,603,360 | 98.3% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 13,792,380 | 27.9% |
| Frees to freelist | 13,808,020 |  |
| Allocations | 35,598,940 | 72.1% |
| Allocations to 512 bytes | 35,307,620 | 71.5% |
| Allocations to 4 kbytes | 279,620 | 0.6% |
| Allocations over 4 kbytes | 11,700 | 0.0% |
| Frees | 34,732,200 |  |
| New values | 17,040 |  |
| Interpreter increfs | 442,790,640 | 83.0% |
| Interpreter decrefs | 491,831,540 | 85.6% |
| Increfs | 90,696,960 | 17.0% |
| Decrefs | 82,983,321 | 14.4% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 9,320,170 |  |
| Method cache misses | 104,630 |  |
| Method cache collisions | 105,889 |  |
| Method cache dunder hits | 2,293,413 |  |
| Method cache dunder misses | 2,967 |  |
...
|---:|---:|---:|---:|
| 0 | 3,500 | 2,300 | 14,082,560 |
| 1 | 320 | 0 | 13,913,800 |
| 2 | 20 | 675,720 | 10,458,520 |
...
| Traces executed | 7,658,460 |  |
| Uops executed | 228,503,320 | 29.84 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 31,655,460 | 13.9% | 13.9% |  |
| _GUARD_TYPE_VERSION | 28,214,140 | 12.3% | 26.2% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 28,136,300 | 12.3% | 38.5% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 28,136,300 | 12.3% | 50.8% |  |
| _SET_IP | 20,943,400 | 9.2% | 60.0% |  |
| _GUARD_IS_FALSE_POP | 17,769,920 | 7.8% | 67.8% | 8.8% |
| _CHECK_VALIDITY | 14,080,460 | 6.2% | 73.9% |  |
| TO_BOOL_LIST | 6,867,200 | 3.0% | 76.9% |  |
| _TO_BOOL | 6,866,680 | 3.0% | 79.9% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 5,523,380 | 2.4% | 82.4% | 99.3% |
| _CHECK_CALL_BOUND_METHOD_EXACT_ARGS | 5,495,520 | 2.4% | 84.8% |  |
| _INIT_CALL_BOUND_METHOD_EXACT_ARGS | 5,495,520 | 2.4% | 87.2% |  |
| STORE_FAST | 3,628,280 | 1.6% | 88.8% |  |
| _JUMP_TO_TOP | 3,312,360 | 1.4% | 90.2% |  |
| TO_BOOL_BOOL | 2,988,220 | 1.3% | 91.5% | 0.0% |
| _LOAD_CONST_INLINE_BORROW | 2,569,580 | 1.1% | 92.6% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 2,492,740 | 1.1% | 93.7% | 0.5% |
| _ITER_CHECK_RANGE | 2,492,740 | 1.1% | 94.8% |  |
| _ITER_NEXT_RANGE | 2,479,380 | 1.1% | 95.9% |  |
| _STORE_SUBSCR | 2,458,880 | 1.1% | 97.0% |  |
| _FOR_ITER_TIER_TWO | 1,293,660 | 0.6% | 97.5% | 22.0% |
| CONTAINS_OP | 1,024,680 | 0.4% | 98.0% |  |
| _CHECK_VALIDITY_AND_SET_IP | 1,020,180 | 0.4% | 98.4% |  |
| _COMPARE_OP | 1,004,320 | 0.4% | 98.9% |  |
| _BINARY_OP | 1,001,240 | 0.4% | 99.3% |  |
| _ITER_CHECK_LIST | 274,920 | 0.1% | 99.4% | 0.1% |
| _GUARD_NOT_EXHAUSTED_LIST | 274,720 | 0.1% | 99.6% | 90.7% |
| _CHECK_GLOBALS | 50,460 | 0.0% | 99.6% |  |
| _GUARD_IS_TRUE_POP | 47,060 | 0.0% | 99.6% | 28.6% |
| _LOAD_CONST_INLINE | 46,720 | 0.0% | 99.6% |  |
...
| _EXIT_TRACE | 35,880 | 0.0% | 99.7% | 100.0% |
...
| _GUARD_BOTH_INT | 26,200 | 0.0% | 99.9% |  |
...
| _LOAD_CONST_INLINE_WITH_NULL | 12,240 | 0.0% | 100.0% |  |
| _CHECK_BUILTINS | 12,000 | 0.0% | 100.0% |  |
| TO_BOOL_NONE | 10,860 | 0.0% | 100.0% |  |
| _GUARD_IS_NOT_NONE_POP | 9,680 | 0.0% | 100.0% | 2.7% |
| POP_TOP | 8,620 | 0.0% | 100.0% |  |
| _GUARD_NOT_EXHAUSTED_TUPLE | 8,540 | 0.0% | 100.0% | 16.4% |
| _ITER_CHECK_TUPLE | 8,540 | 0.0% | 100.0% |  |
