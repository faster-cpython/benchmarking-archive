...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 32,116,700 | 11.5% |
|          hit | 246,050,580 | 88.4% |
|         miss | 376,020 | 0.1% |
...
| Specialized hits | 802,402,080 | 35.7% |
...
| Calls to Python functions inlined | 78,465,940 | 62.3% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 65,056,169 | 18.4% |
| Frees to freelist | 65,505,709 |  |
| Allocations | 288,919,827 | 81.6% |
| Allocations to 512 bytes | 286,995,622 | 81.1% |
| Allocations to 4 kbytes | 1,924,082 | 0.5% |
| Allocations over 4 kbytes | 123 | 0.0% |
| Frees | 291,026,325 |  |
| New values | 420 |  |
| Interpreter increfs | 1,304,572,480 | 79.2% |
| Interpreter decrefs | 1,369,410,571 | 69.2% |
| Increfs | 341,978,226 | 20.8% |
| Decrefs | 609,991,957 | 30.8% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 88,933,448 |  |
| Method cache misses | 778,212 |  |
| Method cache collisions | 776,662 |  |
| Method cache dunder hits | 12,911,607 |  |
...
| Traces executed | 19,154,580 |  |
| Uops executed | 754,886,160 | 39.41 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 94,070,880 | 12.5% | 12.5% |  |
| _GUARD_TYPE_VERSION | 81,021,360 | 10.7% | 23.2% | 0.2% |
| _SET_IP | 72,099,080 | 9.6% | 32.7% |  |
| _CHECK_VALIDITY | 72,097,280 | 9.6% | 42.3% |  |
| _LOAD_ATTR_SLOT | 39,754,920 | 5.3% | 47.6% |  |
| _CHECK_VALIDITY_AND_SET_IP | 33,595,920 | 4.5% | 52.0% |  |
| STORE_FAST | 28,118,080 | 3.7% | 55.7% |  |
| _GUARD_IS_FALSE_POP | 23,818,720 | 3.2% | 58.9% | 0.1% |
| TO_BOOL_BOOL | 23,515,160 | 3.1% | 62.0% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 20,727,400 | 2.7% | 64.8% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 20,727,400 | 2.7% | 67.5% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 20,161,040 | 2.7% | 70.2% |  |
| _EXIT_TRACE | 17,445,600 | 2.3% | 72.5% | 100.0% |
| _LOAD_ATTR | 17,355,760 | 2.3% | 74.8% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 13,812,880 | 1.8% | 76.6% |  |
| PUSH_NULL | 10,195,000 | 1.4% | 78.0% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 10,082,560 | 1.3% | 79.3% | 0.0% |
| _ITER_CHECK_RANGE | 10,082,560 | 1.3% | 80.6% |  |
| _ITER_NEXT_RANGE | 10,080,760 | 1.3% | 82.0% |  |
| BUILD_LIST | 9,891,520 | 1.3% | 83.3% |  |
| CALL_INTRINSIC_1 | 9,891,520 | 1.3% | 84.6% |  |
| LIST_EXTEND | 9,891,520 | 1.3% | 85.9% |  |
| RESUME_CHECK | 9,891,520 | 1.3% | 87.2% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 9,891,520 | 1.3% | 88.5% |  |
| _CHECK_STACK_SPACE | 9,891,520 | 1.3% | 89.8% |  |
| _INIT_CALL_PY_EXACT_ARGS | 9,891,520 | 1.3% | 91.1% |  |
| _PUSH_FRAME | 9,891,520 | 1.3% | 92.5% |  |
| _SAVE_RETURN_OFFSET | 9,891,520 | 1.3% | 93.8% |  |
| _GUARD_NOT_EXHAUSTED_TUPLE | 4,478,580 | 0.6% | 94.4% | 16.7% |
| _ITER_CHECK_TUPLE | 4,478,580 | 0.6% | 94.9% |  |
| _GUARD_NOT_EXHAUSTED_LIST | 4,478,560 | 0.6% | 95.5% | 16.7% |
| _ITER_CHECK_LIST | 4,478,560 | 0.6% | 96.1% |  |
| _GUARD_IS_TRUE_POP | 3,920,880 | 0.5% | 96.7% | 0.0% |
| _LOAD_CONST_INLINE | 3,920,880 | 0.5% | 97.2% |  |
| _CHECK_GLOBALS | 3,920,880 | 0.5% | 97.7% |  |
| CONTAINS_OP | 3,732,120 | 0.5% | 98.2% |  |
| _ITER_NEXT_LIST | 3,732,120 | 0.5% | 98.7% |  |
| _ITER_NEXT_TUPLE | 3,732,120 | 0.5% | 99.2% |  |
| _LOAD_CONST_INLINE_WITH_NULL | 3,732,120 | 0.5% | 99.7% |  |
| _LOAD_CONST_INLINE_BORROW | 377,600 | 0.1% | 99.7% |  |
