...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 50,875,620 | 13.6% |
|          hit | 322,954,120 | 86.4% |
|         miss | 78,280 | 0.0% |
...
| Specialized hits | 2,291,638,880 | 30.5% |
...
| Calls to Python functions inlined | 203,416,640 | 31.8% |
...
| Allocations | 479,309,600 | 48.5% |
| Allocations to 512 bytes | 478,702,340 | 48.4% |
| Allocations to 4 kbytes | 605,340 | 0.1% |
| Allocations over 4 kbytes | 1,920 | 0.0% |
| Frees | 479,735,962 |  |
| New values | 20 |  |
| Interpreter increfs | 5,388,762,960 | 72.6% |
| Interpreter decrefs | 6,326,878,000 | 75.3% |
| Increfs | 2,033,994,117 | 27.4% |
| Decrefs | 2,076,299,556 | 24.7% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 101,931,010 |  |
| Method cache misses | 425,110 |  |
| Method cache collisions | 849,398 |  |
| Method cache dunder hits | 70,800,269 |  |
| Method cache dunder misses | 424,731 |  |
...
| Traces executed | 373,013,640 |  |
| Uops executed | 6,305,464,180 | 16.90 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| _SET_IP | 803,713,980 | 12.7% | 12.7% |  |
| LOAD_FAST | 779,081,120 | 12.4% | 25.1% |  |
| _CHECK_VALIDITY | 704,307,900 | 11.2% | 36.3% |  |
| STORE_FAST | 614,573,380 | 9.7% | 46.0% |  |
| _ITER_CHECK_LIST | 389,822,440 | 6.2% | 52.2% | 0.4% |
| _GUARD_NOT_EXHAUSTED_LIST | 388,215,200 | 6.2% | 58.4% | 16.2% |
| _ITER_NEXT_LIST | 325,175,020 | 5.2% | 63.5% |  |
| _EXIT_TRACE | 287,687,400 | 4.6% | 68.1% | 100.0% |
| _BINARY_SUBSCR | 283,967,100 | 4.5% | 72.6% |  |
| LOAD_DEREF | 260,162,200 | 4.1% | 76.7% |  |
| UNPACK_SEQUENCE_TWO_TUPLE | 249,972,100 | 4.0% | 80.7% |  |
| _GUARD_BOTH_FLOAT | 239,525,400 | 3.8% | 84.5% |  |
| _BINARY_OP_MULTIPLY_FLOAT | 239,525,400 | 3.8% | 88.3% |  |
| _LOAD_CONST_INLINE_BORROW | 86,587,260 | 1.4% | 89.6% |  |
| _JUMP_TO_TOP | 51,764,160 | 0.8% | 90.5% |  |
| COPY | 47,609,800 | 0.8% | 91.2% |  |
| SWAP | 47,609,800 | 0.8% | 92.0% |  |
| _BINARY_OP | 47,168,660 | 0.7% | 92.7% |  |
| CONTAINS_OP | 44,174,060 | 0.7% | 93.4% |  |
| _GUARD_IS_FALSE_POP | 33,556,060 | 0.5% | 94.0% | 24.5% |
| BINARY_SUBSCR_TUPLE_INT | 29,337,200 | 0.5% | 94.4% |  |
| COMPARE_OP_INT | 27,883,860 | 0.4% | 94.9% |  |
| _GUARD_BOTH_INT | 26,493,060 | 0.4% | 95.3% |  |
| _STORE_SUBSCR | 23,804,900 | 0.4% | 95.7% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 22,831,840 | 0.4% | 96.0% | 2.6% |
| _ITER_CHECK_RANGE | 22,831,840 | 0.4% | 96.4% |  |
| LIST_APPEND | 22,246,400 | 0.4% | 96.7% |  |
| _BINARY_OP_MULTIPLY_INT | 22,246,400 | 0.4% | 97.1% |  |
| _ITER_NEXT_RANGE | 22,246,400 | 0.4% | 97.4% |  |
| _GUARD_IS_TRUE_POP | 17,215,880 | 0.3% | 97.7% | 58.1% |
| _LOAD_ATTR | 15,009,360 | 0.2% | 98.0% |  |
| _CHECK_VALIDITY_AND_SET_IP | 14,840,300 | 0.2% | 98.2% |  |
| _LOAD_CONST_INLINE_WITH_NULL | 12,290,140 | 0.2% | 98.4% |  |
| _CHECK_GLOBALS | 9,729,020 | 0.2% | 98.5% |  |
| _FOR_ITER_TIER_TWO | 9,680,320 | 0.2% | 98.7% | 16.5% |
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 7,750,920 | 0.1% | 98.8% |  |
| _GUARD_TYPE_VERSION | 7,011,060 | 0.1% | 98.9% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 6,825,460 | 0.1% | 99.0% |  |
| _CHECK_BUILTINS | 5,482,360 | 0.1% | 99.1% |  |
| _LOAD_CONST_INLINE | 4,803,460 | 0.1% | 99.2% |  |
| RESUME_CHECK | 4,432,260 | 0.1% | 99.3% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 4,432,260 | 0.1% | 99.3% |  |
| _CHECK_STACK_SPACE | 4,432,260 | 0.1% | 99.4% |  |
| _INIT_CALL_PY_EXACT_ARGS | 4,432,260 | 0.1% | 99.5% |  |
| _PUSH_FRAME | 4,432,260 | 0.1% | 99.5% |  |
| _SAVE_RETURN_OFFSET | 4,432,260 | 0.1% | 99.6% |  |
| _BINARY_OP_ADD_INT | 4,246,660 | 0.1% | 99.7% |  |
| UNARY_NEGATIVE | 3,875,460 | 0.1% | 99.7% |  |
| BUILD_TUPLE | 3,171,700 | 0.1% | 99.8% |  |
