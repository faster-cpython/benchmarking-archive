...
|---|---:|---:|---:|---:|
| LOAD_FAST | 110,083,520 | 19.9% | 19.9% |  |
| RESUME_CHECK | 41,639,580 | 7.5% | 27.5% | 0.0% |
| RETURN_VALUE | 34,272,440 | 6.2% | 33.7% |  |
| LOAD_GLOBAL_BUILTIN | 24,193,500 | 4.4% | 38.1% |  |
| STORE_FAST | 22,772,640 | 4.1% | 42.2% |  |
...
| LOAD_GLOBAL_MODULE | 13,465,600 | 2.4% | 60.7% |  |
| PUSH_NULL | 13,455,940 | 2.4% | 63.2% |  |
| LOAD_FAST_LOAD_FAST | 12,815,720 | 2.3% | 65.5% |  |
| CALL | 12,658,600 | 2.3% | 67.8% |  |
| LOAD_ATTR_METHOD_NO_DICT | 11,217,700 | 2.0% | 69.8% |  |
| POP_TOP | 10,093,580 | 1.8% | 71.6% |  |
| LOAD_ATTR_PROPERTY | 10,089,020 | 1.8% | 73.5% |  |
| LOAD_ATTR_MODULE | 9,458,780 | 1.7% | 75.2% |  |
| ENTER_EXECUTOR | 8,802,300 | 1.6% | 76.8% |  |
...
| LOAD_CONST | 4,040,560 | 0.7% | 87.4% |  |
| CALL_STR_1 | 4,006,900 | 0.7% | 88.1% |  |
| GET_ITER | 3,369,760 | 0.6% | 88.7% |  |
| LOAD_ATTR | 3,368,380 | 0.6% | 89.3% |  |
| CALL_BUILTIN_FAST_WITH_KEYWORDS | 3,365,500 | 0.6% | 89.9% |  |
| LOAD_DEREF | 3,364,640 | 0.6% | 90.5% |  |
...
| JUMP_BACKWARD | 3,203,200 | 0.6% | 96.6% |  |
...
| CALL_PY_EXACT_ARGS | 1,289,360 | 0.2% | 99.7% |  |
...
| LOAD_FAST LOAD_ATTR_METHOD_NO_DICT | 11,213,980 | 2.0% | 22.6% |
...
| STORE_FAST LOAD_FAST | 9,945,680 | 1.8% | 31.8% |
| LOAD_ATTR_METHOD_NO_DICT LOAD_FAST | 8,008,380 | 1.5% | 33.3% |
| RESUME_CHECK LOAD_FAST | 7,375,780 | 1.3% | 34.6% |
...
| LOAD_GLOBAL_MODULE LOAD_ATTR_MODULE | 6,730,660 | 1.2% | 39.9% |
| LOAD_ATTR_MODULE PUSH_NULL | 6,729,620 | 1.2% | 41.1% |
| STORE_FAST LOAD_GLOBAL_BUILTIN | 6,729,360 | 1.2% | 42.3% |
...
| POP_TOP ENTER_EXECUTOR | 3,519,120 | 0.6% | 57.3% |
...
| POP_TOP JUMP_BACKWARD | 3,201,680 | 0.6% | 89.5% |
...
| STORE_FAST | 9,945,680 | 9.0% |

|Successors | Count | Percentage | 
|---|---:|---:|
| LOAD_ATTR_SLOT | 18,093,580 | 16.4% |
| LOAD_ATTR_METHOD_NO_DICT | 11,213,980 | 10.2% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| JUMP_BACKWARD | 640 | 76.2% |
| GET_ITER | 140 | 16.7% |
| ENTER_EXECUTOR | 40 | 4.8% |
| FOR_ITER | 20 | 2.4% |
...
|Predecessors | Count | Percentage | 
|---|---:|---:|
| LOAD_GLOBAL_MODULE | 6,730,660 | 71.2% |
...
|---|---:|---:|
| Basic | 314,047,380 | 56.9% |
| Not specialized | 42,175,180 | 7.6% |
| Specialized hits | 194,888,380 | 35.3% |
...
| Calls to Python functions inlined | 21,310,060 | 51.2% |
...
| Allocations | 106,624,100 | 71.1% |
| Allocations to 512 bytes | 106,624,020 | 71.1% |
| Allocations to 4 kbytes | 80 | 0.0% |
| Allocations over 4 kbytes | 0 | 0.0% |
| Frees | 115,912,295 |  |
| New values | 60 |  |
| Interpreter increfs | 343,981,700 | 79.2% |
| Interpreter decrefs | 367,400,140 | 64.2% |
| Increfs | 90,497,769 | 20.8% |
| Decrefs | 205,258,059 | 35.8% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 9,834 |  |
| Method cache misses | 946 |  |
| Method cache collisions | 791 |  |
| Method cache dunder hits | 30,264,381 |  |
...
| Traces executed | 8,802,300 |  |
| Uops executed | 133,701,380 | 15.19 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 21,267,860 | 15.9% | 15.9% |  |
| _SET_IP | 8,315,920 | 6.2% | 22.1% |  |
| _CHECK_VALIDITY | 8,315,620 | 6.2% | 28.3% |  |
| STORE_FAST | 8,155,300 | 6.1% | 34.4% |  |
| _ITER_CHECK_LIST | 5,441,060 | 4.1% | 38.5% | 0.0% |
| _GUARD_NOT_EXHAUSTED_LIST | 5,440,980 | 4.1% | 42.6% | 0.1% |
| _GUARD_TYPE_VERSION | 5,436,800 | 4.1% | 46.7% |  |
| _ITER_NEXT_LIST | 5,436,140 | 4.1% | 50.7% |  |
| _EXIT_TRACE | 5,436,080 | 4.1% | 54.8% | 100.0% |
| _GUARD_NOT_EXHAUSTED_TUPLE | 3,361,040 | 2.5% | 57.3% | 100.0% |
| _ITER_CHECK_TUPLE | 3,361,040 | 2.5% | 59.8% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 2,877,920 | 2.2% | 62.0% |  |
| _CHECK_VALIDITY_AND_SET_IP | 2,718,640 | 2.0% | 64.0% |  |
| _GUARD_IS_TRUE_POP | 2,718,580 | 2.0% | 66.0% | 0.0% |
| RESUME_CHECK | 2,718,560 | 2.0% | 68.1% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 2,718,560 | 2.0% | 70.1% |  |
| _CHECK_STACK_SPACE | 2,718,560 | 2.0% | 72.1% |  |
| _INIT_CALL_PY_EXACT_ARGS | 2,718,560 | 2.0% | 74.2% |  |
| _PUSH_FRAME | 2,718,560 | 2.0% | 76.2% |  |
| _SAVE_RETURN_OFFSET | 2,718,560 | 2.0% | 78.2% |  |
| _CHECK_GLOBALS | 2,718,460 | 2.0% | 80.3% |  |
| CALL_STR_1 | 2,718,380 | 2.0% | 82.3% |  |
| TO_BOOL_STR | 2,718,380 | 2.0% | 84.3% |  |
| _LOAD_CONST_INLINE_BORROW_WITH_NULL | 2,718,380 | 2.0% | 86.4% |  |
| _CHECK_BUILTINS | 2,718,380 | 2.0% | 88.4% |  |
| LOAD_DEREF | 2,718,320 | 2.0% | 90.4% |  |
| _GUARD_IS_FALSE_POP | 2,558,660 | 1.9% | 92.3% | 0.0% |
| _GUARD_IS_NOT_NONE_POP | 2,558,260 | 1.9% | 94.3% | 0.0% |
| PUSH_NULL | 2,558,260 | 1.9% | 96.2% |  |
| TO_BOOL_BOOL | 2,558,080 | 1.9% | 98.1% |  |
| _LOAD_ATTR_SLOT | 2,558,080 | 1.9% | 100.0% |  |
| _LOAD_CONST_INLINE | 580 | 0.0% | 100.0% |  |
...
| _CHECK_ATTR_MODULE | 60 | 0.0% | 100.0% |  |
| _LOAD_ATTR_MODULE | 60 | 0.0% | 100.0% |  |
