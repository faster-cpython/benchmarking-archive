...
| Increfs | 460,465,269 | 98.9% |
| Decrefs | 641,465,069 | 98.8% |
| Materialize dict (on request) | 0 |  |
| Materialize dict (new key) | 0 |  |
| Materialize dict (too big) | 0 |  |
| Materialize dict (str subclass) | 0 |  |
| Dematerialize dict | 0 |  |
| Method cache hits | 4,086,540 |  |
| Method cache misses | 829,560 |  |
| Method cache collisions | 829,176 |  |
| Method cache dunder hits | 1,639,023 |  |
