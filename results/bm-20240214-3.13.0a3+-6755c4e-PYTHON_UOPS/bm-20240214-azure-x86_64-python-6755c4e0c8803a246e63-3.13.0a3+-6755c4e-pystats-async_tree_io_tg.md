...
| RESUME | 1,980 | 0.0% | 100.0% | 3,763.6% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 60,473,900 | 22.3% |
|          hit | 210,989,400 | 77.7% |
|         miss | 761,180 | 0.3% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 43,331,200 | 7.3% |
|          hit | 552,593,760 | 92.7% |
|         miss | 26,040 | 0.0% |
...
| Specialized hits | 1,674,997,301 | 41.2% |
| Specialized misses | 921,419 | 0.0% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 128,101,300 | 48.4% |
| Calls to Python functions inlined | 136,624,800 | 51.6% |
| Calls via PyEval_EvalFrame (total) | 128,101,300 | 48.4% |
| Calls via PyEval_EvalFrame (vector) | 119,143,380 | 45.0% |
| Calls via PyEval_EvalFrame (generator) | 8,957,920 | 3.4% |
| Calls via PyEval_EvalFrame (legacy) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 119,143,380 | 45.0% |
| Calls via PyEval_EvalFrame (build class) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (slot) | 57,183,440 | 21.6% |
| Calls via PyEval_EvalFrame (function ex) | 80 | 0.0% |
| Calls via PyEval_EvalFrame (api) | 4,479,100 | 1.7% |
| Calls via PyEval_EvalFrame (method) | 26,873,760 | 10.2% |
| Frame objects created | 180 | 0.0% |
| Frames pushed | 113,478,980 | 42.9% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 106,777,411 | 38.1% |
| Frees to freelist | 107,301,360 |  |
| Allocations | 173,513,774 | 61.9% |
| Allocations to 512 bytes | 172,651,669 | 61.6% |
| Allocations to 4 kbytes | 862,000 | 0.3% |
| Allocations over 4 kbytes | 105 | 0.0% |
| Frees | 173,428,870 |  |
| New values | 440 |  |
| Interpreter increfs | 2,594,644,260 | 79.1% |
| Interpreter decrefs | 2,715,385,246 | 77.2% |
| Increfs | 686,846,351 | 20.9% |
| Decrefs | 801,952,623 | 22.8% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 83,715,365 |  |
| Method cache misses | 6,135 |  |
| Method cache collisions | 5,813 |  |
| Method cache dunder hits | 75,847,172 |  |
...
|---:|---:|---:|---:|
| 0 | 94,977 | 2,040 | 678,337,990 |
| 1 | 8,640 | 0 | 731,754,356 |
| 2 | 660 | 0 | 2,416,631,366 |
...
| Traces executed | 17,169,220 |  |
| Uops executed | 1,105,410,240 | 64.38 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| _GUARD_TYPE_VERSION | 144,800,080 | 13.1% | 13.1% | 2.6% |
| LOAD_FAST | 131,364,920 | 11.9% | 25.0% |  |
| _SET_IP | 106,735,720 | 9.7% | 34.6% |  |
| _CHECK_VALIDITY | 106,733,920 | 9.7% | 44.3% |  |
| _LOAD_ATTR_SLOT | 57,471,440 | 5.2% | 49.5% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 45,530,160 | 4.1% | 53.6% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 45,530,160 | 4.1% | 57.7% |  |
| _CHECK_VALIDITY_AND_SET_IP | 44,036,920 | 4.0% | 61.7% |  |
| STORE_FAST | 41,798,560 | 3.8% | 65.5% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 34,334,080 | 3.1% | 68.6% |  |
| _GUARD_IS_FALSE_POP | 30,601,760 | 2.8% | 71.4% | 0.0% |
| TO_BOOL_BOOL | 26,869,680 | 2.4% | 73.8% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 17,169,040 | 1.6% | 75.4% | 0.0% |
| _ITER_CHECK_RANGE | 17,169,040 | 1.6% | 76.9% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 17,167,240 | 1.6% | 78.5% |  |
| _ITER_NEXT_RANGE | 17,167,240 | 1.6% | 80.0% |  |
| PUSH_NULL | 17,166,840 | 1.6% | 81.6% |  |
| _EXIT_TRACE | 13,434,840 | 1.2% | 82.8% | 100.0% |
| BUILD_LIST | 13,434,840 | 1.2% | 84.0% |  |
| CALL_INTRINSIC_1 | 13,434,840 | 1.2% | 85.2% |  |
| LIST_EXTEND | 13,434,840 | 1.2% | 86.4% |  |
| RESUME_CHECK | 13,434,840 | 1.2% | 87.6% |  |
| _LOAD_ATTR | 13,434,840 | 1.2% | 88.9% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 13,434,840 | 1.2% | 90.1% |  |
| _CHECK_STACK_SPACE | 13,434,840 | 1.2% | 91.3% |  |
| _INIT_CALL_PY_EXACT_ARGS | 13,434,840 | 1.2% | 92.5% |  |
| _PUSH_FRAME | 13,434,840 | 1.2% | 93.7% |  |
| _SAVE_RETURN_OFFSET | 13,434,840 | 1.2% | 94.9% |  |
| _LOAD_CONST_INLINE_BORROW | 7,464,080 | 0.7% | 95.6% |  |
| BINARY_SUBSCR_LIST_INT | 3,732,080 | 0.3% | 95.9% |  |
| COMPARE_OP_FLOAT | 3,732,080 | 0.3% | 96.3% |  |
| _GUARD_IS_TRUE_POP | 3,732,000 | 0.3% | 96.6% | 0.0% |
| POP_TOP | 3,732,000 | 0.3% | 97.0% |  |
| CALL_BUILTIN_O | 3,732,000 | 0.3% | 97.3% |  |
| CALL_METHOD_DESCRIPTOR_O | 3,732,000 | 0.3% | 97.6% |  |
| TO_BOOL_LIST | 3,732,000 | 0.3% | 98.0% |  |
| _CHECK_ATTR_MODULE | 3,732,000 | 0.3% | 98.3% |  |
| _LOAD_ATTR_MODULE | 3,732,000 | 0.3% | 98.6% |  |
| _STORE_ATTR_SLOT | 3,732,000 | 0.3% | 99.0% |  |
| _LOAD_CONST_INLINE | 3,732,000 | 0.3% | 99.3% |  |
