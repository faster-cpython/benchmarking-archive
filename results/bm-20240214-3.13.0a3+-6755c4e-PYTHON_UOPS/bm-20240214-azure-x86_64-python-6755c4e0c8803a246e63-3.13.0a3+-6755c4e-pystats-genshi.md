...
| Not specialized | 274,863,900 | 10.9% |
| Specialized hits | 728,078,980 | 28.8% |
...
| Calls to Python functions inlined | 122,637,080 | 81.9% |
...
| Frees | 74,680,032 |  |
| New values | 2,820 |  |
| Interpreter increfs | 1,091,260,340 | 81.3% |
| Interpreter decrefs | 1,138,661,600 | 78.5% |
| Increfs | 250,858,948 | 18.7% |
| Decrefs | 311,736,890 | 21.5% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 42,860,951 |  |
| Method cache misses | 16,349 |  |
| Method cache collisions | 14,019 |  |
| Method cache dunder hits | 10,974,239 |  |
| Method cache dunder misses | 2,761 |  |
...
| Traces executed | 39,855,980 |  |
| Uops executed | 259,359,640 | 6.51 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 40,051,560 | 15.4% | 15.4% |  |
| STORE_FAST | 32,660,860 | 12.6% | 28.0% |  |
| _ITER_CHECK_LIST | 27,047,380 | 10.4% | 38.5% | 40.2% |
| _SET_IP | 19,072,040 | 7.4% | 45.8% |  |
| _EXIT_TRACE | 18,724,200 | 7.2% | 53.0% | 100.0% |
| _CHECK_VALIDITY | 18,106,100 | 7.0% | 60.0% |  |
| _GUARD_NOT_EXHAUSTED_LIST | 16,167,520 | 6.2% | 66.3% | 32.7% |
| _FOR_ITER_TIER_TWO | 11,687,480 | 4.5% | 70.8% | 8.2% |
| _ITER_NEXT_LIST | 10,884,100 | 4.2% | 75.0% |  |
| _LOAD_CONST_INLINE | 7,526,940 | 2.9% | 77.9% |  |
| _GUARD_IS_FALSE_POP | 7,372,900 | 2.8% | 80.7% | 26.1% |
| PUSH_NULL | 6,720,380 | 2.6% | 83.3% |  |
| _CHECK_GLOBALS | 5,609,340 | 2.2% | 85.5% |  |
| _LOAD_CONST_INLINE_BORROW | 5,446,840 | 2.1% | 87.6% |  |
| IS_OP | 5,446,020 | 2.1% | 89.7% |  |
| UNPACK_SEQUENCE_TUPLE | 5,442,100 | 2.1% | 91.8% |  |
| _GUARD_IS_TRUE_POP | 4,002,600 | 1.5% | 93.3% | 52.0% |
| _LOAD_CONST_INLINE_WITH_NULL | 3,848,600 | 1.5% | 94.8% |  |
| TO_BOOL_LIST | 3,520,220 | 1.4% | 96.1% |  |
| _CHECK_BUILTINS | 2,085,740 | 0.8% | 96.9% |  |
| CALL_BUILTIN_FAST | 1,924,640 | 0.7% | 97.7% |  |
| CALL_LEN | 1,920,100 | 0.7% | 98.4% |  |
| COMPARE_OP_INT | 1,920,040 | 0.7% | 99.2% |  |
| GET_ITER | 961,000 | 0.4% | 99.5% |  |
| CONTAINS_OP | 483,300 | 0.2% | 99.7% |  |
...
| _GUARD_TYPE_VERSION | 9,120 | 0.0% | 100.0% | 1.1% |
| _CHECK_VALIDITY_AND_SET_IP | 6,040 | 0.0% | 100.0% |  |
| BUILD_TUPLE | 4,440 | 0.0% | 100.0% |  |
| TO_BOOL_BOOL | 4,320 | 0.0% | 100.0% | 0.5% |
| POP_TOP | 3,880 | 0.0% | 100.0% |  |
...
| UNPACK_SEQUENCE_TWO_TUPLE | 2,720 | 0.0% | 100.0% |  |
| _GUARD_IS_NOT_NONE_POP | 2,120 | 0.0% | 100.0% | 5.7% |
| RESUME_CHECK | 1,940 | 0.0% | 100.0% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 1,940 | 0.0% | 100.0% |  |
| _CHECK_STACK_SPACE | 1,940 | 0.0% | 100.0% |  |
| _INIT_CALL_PY_EXACT_ARGS | 1,940 | 0.0% | 100.0% |  |
| _PUSH_FRAME | 1,940 | 0.0% | 100.0% |  |
| _SAVE_RETURN_OFFSET | 1,940 | 0.0% | 100.0% |  |
...
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 960 | 0.0% | 100.0% |  |
| _GUARD_KEYS_VERSION | 960 | 0.0% | 100.0% |  |
| _LOAD_ATTR_METHOD_WITH_VALUES | 960 | 0.0% | 100.0% |  |
