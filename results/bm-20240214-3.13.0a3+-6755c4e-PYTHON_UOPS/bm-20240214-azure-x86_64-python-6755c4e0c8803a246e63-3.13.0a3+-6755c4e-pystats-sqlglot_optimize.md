...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 10,664,580 | 17.9% |
|        deopt | 439,820 | 0.7% |
|          hit | 48,552,180 | 81.7% |
|         miss | 10,161,560 | 17.1% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 10,429,680 | 23.8% |
| Calls to Python functions inlined | 33,443,900 | 76.2% |
| Calls via PyEval_EvalFrame (total) | 10,429,680 | 23.8% |
...
| Frees | 61,796,122 |  |
| New values | 151,840 |  |
| Interpreter increfs | 386,082,780 | 67.1% |
| Interpreter decrefs | 444,605,700 | 67.1% |
| Increfs | 189,311,841 | 32.9% |
| Decrefs | 217,895,616 | 32.9% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 12,670,071 |  |
| Method cache misses | 655,389 |  |
| Method cache collisions | 680,043 |  |
| Method cache dunder hits | 63,371,036 |  |
| Method cache dunder misses | 29,544 |  |
...
| Traces executed | 17,432,420 |  |
| Uops executed | 274,535,600 | 15.75 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| _SET_IP | 35,769,900 | 13.0% | 13.0% |  |
| LOAD_FAST | 31,748,240 | 11.6% | 24.6% |  |
| _CHECK_VALIDITY | 29,377,420 | 10.7% | 35.3% |  |
| STORE_FAST | 19,872,360 | 7.2% | 42.5% |  |
| _FOR_ITER_TIER_TWO | 12,966,120 | 4.7% | 47.3% | 47.9% |
| _LOAD_CONST_INLINE_WITH_NULL | 12,705,060 | 4.6% | 51.9% |  |
| _CHECK_GLOBALS | 9,508,280 | 3.5% | 55.3% |  |
| _GUARD_IS_FALSE_POP | 9,089,220 | 3.3% | 58.7% | 6.7% |
| TO_BOOL_BOOL | 8,820,800 | 3.2% | 61.9% |  |
| CALL_ISINSTANCE | 8,334,680 | 3.0% | 64.9% |  |
| _CHECK_BUILTINS | 7,311,080 | 2.7% | 67.6% |  |
| _LOAD_CONST_INLINE_BORROW | 6,530,580 | 2.4% | 69.9% |  |
| UNPACK_SEQUENCE_TWO_TUPLE | 6,514,660 | 2.4% | 72.3% |  |
| _GUARD_NOT_EXHAUSTED_LIST | 6,296,520 | 2.3% | 74.6% | 84.0% |
| _ITER_CHECK_LIST | 6,296,520 | 2.3% | 76.9% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 4,421,180 | 1.6% | 78.5% | 0.9% |
| RESUME_CHECK | 4,379,740 | 1.6% | 80.1% |  |
| _CHECK_STACK_SPACE | 4,379,740 | 1.6% | 81.7% |  |
| _INIT_CALL_PY_EXACT_ARGS | 4,379,740 | 1.6% | 83.3% |  |
| _PUSH_FRAME | 4,379,740 | 1.6% | 84.9% |  |
| _SAVE_RETURN_OFFSET | 4,379,740 | 1.6% | 86.5% |  |
| _CHECK_VALIDITY_AND_SET_IP | 3,722,280 | 1.4% | 87.9% |  |
| _EXIT_TRACE | 3,371,840 | 1.2% | 89.1% | 100.0% |
| _POP_FRAME | 2,818,100 | 1.0% | 90.1% |  |
| _JUMP_TO_TOP | 2,723,920 | 1.0% | 91.1% |  |
| _GUARD_TYPE_VERSION | 2,629,840 | 1.0% | 92.1% | 4.5% |
| BUILD_TUPLE | 2,614,680 | 1.0% | 93.0% |  |
| _LOAD_CONST_INLINE | 2,058,820 | 0.7% | 93.8% |  |
| MAP_ADD | 1,968,580 | 0.7% | 94.5% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 1,924,320 | 0.7% | 95.2% |  |
| _GUARD_IS_NONE_POP | 1,642,960 | 0.6% | 95.8% | 91.2% |
| BUILD_LIST | 1,458,820 | 0.5% | 96.3% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 1,063,360 | 0.4% | 96.7% |  |
| _ITER_NEXT_LIST | 1,008,260 | 0.4% | 97.1% |  |
| UNPACK_SEQUENCE_TUPLE | 971,200 | 0.4% | 97.4% |  |
| _CHECK_ATTR_MODULE | 926,500 | 0.3% | 97.8% |  |
| _LOAD_ATTR_MODULE | 926,500 | 0.3% | 98.1% |  |
| GET_ITER | 872,540 | 0.3% | 98.4% |  |
| _GUARD_IS_TRUE_POP | 458,440 | 0.2% | 98.6% | 5.8% |
| COPY | 457,340 | 0.2% | 98.7% |  |
| _GUARD_NOT_EXHAUSTED_TUPLE | 440,960 | 0.2% | 98.9% | 34.0% |
| _ITER_CHECK_TUPLE | 440,960 | 0.2% | 99.1% |  |
| TO_BOOL_STR | 319,040 | 0.1% | 99.2% |  |
| _LOAD_ATTR_SLOT | 304,920 | 0.1% | 99.3% |  |
| _ITER_NEXT_TUPLE | 291,020 | 0.1% | 99.4% |  |
| CONTAINS_OP | 205,000 | 0.1% | 99.5% |  |
| _STORE_ATTR_SLOT | 190,640 | 0.1% | 99.5% |  |
| TO_BOOL_ALWAYS_TRUE | 128,500 | 0.0% | 99.6% | 96.2% |
| LOAD_DEREF | 122,800 | 0.0% | 99.6% |  |
| TO_BOOL_NONE | 108,920 | 0.0% | 99.7% |  |
| CALL_METHOD_DESCRIPTOR_FAST | 106,820 | 0.0% | 99.7% | 1.3% |
| PUSH_NULL | 106,200 | 0.0% | 99.7% |  |
| LIST_APPEND | 96,080 | 0.0% | 99.8% |  |
| POP_TOP | 69,540 | 0.0% | 99.8% |  |
| _LOAD_ATTR_NONDESCRIPTOR_NO_DICT | 58,420 | 0.0% | 99.8% |  |
| CALL_METHOD_DESCRIPTOR_O | 54,940 | 0.0% | 99.9% |  |
...
| _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT | 22,660 | 0.0% | 99.9% |  |
| _GUARD_KEYS_VERSION | 22,660 | 0.0% | 99.9% |  |
| _BINARY_SUBSCR | 21,440 | 0.0% | 99.9% |  |
| _LOAD_ATTR_METHOD_WITH_VALUES | 21,420 | 0.0% | 99.9% |  |
| COMPARE_OP_STR | 20,820 | 0.0% | 99.9% |  |
| STORE_SUBSCR_DICT | 17,160 | 0.0% | 99.9% |  |
...
| COPY_FREE_VARS | 7,720 | 0.0% | 100.0% |  |
