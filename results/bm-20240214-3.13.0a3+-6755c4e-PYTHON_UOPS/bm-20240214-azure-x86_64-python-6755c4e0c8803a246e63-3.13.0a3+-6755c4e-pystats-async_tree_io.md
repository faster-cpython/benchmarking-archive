...
| RESUME | 1,920 | 0.0% | 100.0% | 4,708.5% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 69,431,620 | 23.1% |
|          hit | 231,144,680 | 76.9% |
|         miss | 4,565,360 | 1.5% |
...
|Kind | Count | Ratio | 
|---|---:|---:|
|     deferred | 44,077,780 | 7.8% |
|          hit | 519,002,620 | 92.2% |
|         miss | 26,040 | 0.0% |
...
| Specialized hits | 1,708,575,176 | 40.2% |
| Specialized misses | 4,741,484 | 0.1% |
...
| | Count | Ratio | 
|---|---:|---:|
| Calls to PyEval_EvalDefault | 127,354,800 | 47.0% |
| Calls to Python functions inlined | 143,343,140 | 53.0% |
| Calls via PyEval_EvalFrame (total) | 127,354,800 | 47.0% |
| Calls via PyEval_EvalFrame (vector) | 118,396,880 | 43.7% |
| Calls via PyEval_EvalFrame (generator) | 8,957,920 | 3.3% |
| Calls via PyEval_EvalFrame (legacy) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (function vectorcall) | 118,396,880 | 43.7% |
| Calls via PyEval_EvalFrame (build class) | 0 | 0.0% |
| Calls via PyEval_EvalFrame (slot) | 57,183,440 | 21.1% |
| Calls via PyEval_EvalFrame (function ex) | 746,560 | 0.3% |
| Calls via PyEval_EvalFrame (api) | 4,479,100 | 1.7% |
| Calls via PyEval_EvalFrame (method) | 26,873,760 | 9.9% |
| Frame objects created | 180 | 0.0% |
| Frames pushed | 120,943,820 | 44.7% |
...
| | Count | Ratio | 
|---|---:|---:|
| Allocations from freelist | 114,342,480 | 39.1% |
| Frees to freelist | 114,850,457 |  |
| Allocations | 177,888,261 | 60.9% |
| Allocations to 512 bytes | 177,772,637 | 60.8% |
| Allocations to 4 kbytes | 115,520 | 0.0% |
| Allocations over 4 kbytes | 104 | 0.0% |
| Frees | 179,992,906 |  |
| New values | 420 |  |
| Interpreter increfs | 2,692,432,780 | 78.8% |
| Interpreter decrefs | 2,806,455,363 | 76.6% |
| Increfs | 725,994,285 | 21.2% |
| Decrefs | 857,509,310 | 23.4% |
| Materialize dict (on request) | 0 | 0.0% |
| Materialize dict (new key) | 0 | 0.0% |
| Materialize dict (too big) | 0 | 0.0% |
| Materialize dict (str subclass) | 0 | 0.0% |
| Dematerialize dict | 0 | 0.0% |
| Method cache hits | 106,398,265 |  |
| Method cache misses | 3,450,535 |  |
| Method cache collisions | 3,446,743 |  |
| Method cache dunder hits | 75,100,604 |  |
| Method cache dunder misses | 536 |  |
...
|---:|---:|---:|---:|
| 0 | 92,957 | 2,040 | 659,196,724 |
| 1 | 8,440 | 0 | 711,022,040 |
| 2 | 660 | 0 | 2,262,075,062 |
...
| Traces executed | 26,126,340 |  |
| Uops executed | 1,231,555,960 | 47.14 |
...
|Name | Count | Self | Cumulative | Miss ratio | 
|---|---:|---:|---:|---:|
| LOAD_FAST | 153,757,640 | 12.5% | 12.5% |  |
| _GUARD_TYPE_VERSION | 144,800,080 | 11.8% | 24.2% | 2.6% |
| _SET_IP | 117,932,080 | 9.6% | 33.8% |  |
| _CHECK_VALIDITY | 117,930,280 | 9.6% | 43.4% |  |
| _LOAD_ATTR_SLOT | 57,471,440 | 4.7% | 48.1% |  |
| STORE_FAST | 49,262,800 | 4.0% | 52.1% |  |
| _CHECK_VALIDITY_AND_SET_IP | 47,769,040 | 3.9% | 55.9% |  |
| _CHECK_MANAGED_OBJECT_HAS_VALUES | 45,530,160 | 3.7% | 59.6% |  |
| _LOAD_ATTR_INSTANCE_VALUE | 45,530,160 | 3.7% | 63.3% |  |
| _LOAD_ATTR_METHOD_NO_DICT | 34,334,080 | 2.8% | 66.1% |  |
| _GUARD_IS_FALSE_POP | 34,333,880 | 2.8% | 68.9% | 0.0% |
| TO_BOOL_BOOL | 30,601,800 | 2.5% | 71.4% |  |
| CALL_METHOD_DESCRIPTOR_NOARGS | 20,899,360 | 1.7% | 73.1% |  |
| _EXIT_TRACE | 20,899,080 | 1.7% | 74.8% | 100.0% |
| _LOAD_ATTR | 20,899,080 | 1.7% | 76.5% |  |
| _GUARD_NOT_EXHAUSTED_RANGE | 17,169,040 | 1.4% | 77.9% | 0.0% |
| _ITER_CHECK_RANGE | 17,169,040 | 1.4% | 79.3% |  |
| _ITER_NEXT_RANGE | 17,167,240 | 1.4% | 80.7% |  |
| PUSH_NULL | 17,166,840 | 1.4% | 82.1% |  |
| BUILD_LIST | 13,434,840 | 1.1% | 83.2% |  |
| CALL_INTRINSIC_1 | 13,434,840 | 1.1% | 84.2% |  |
| LIST_EXTEND | 13,434,840 | 1.1% | 85.3% |  |
| RESUME_CHECK | 13,434,840 | 1.1% | 86.4% |  |
| _CHECK_FUNCTION_EXACT_ARGS | 13,434,840 | 1.1% | 87.5% |  |
| _CHECK_STACK_SPACE | 13,434,840 | 1.1% | 88.6% |  |
| _INIT_CALL_PY_EXACT_ARGS | 13,434,840 | 1.1% | 89.7% |  |
| _PUSH_FRAME | 13,434,840 | 1.1% | 90.8% |  |
| _SAVE_RETURN_OFFSET | 13,434,840 | 1.1% | 91.9% |  |
| _GUARD_IS_TRUE_POP | 7,464,120 | 0.6% | 92.5% | 0.0% |
| _LOAD_CONST_INLINE | 7,464,120 | 0.6% | 93.1% |  |
| _CHECK_GLOBALS | 7,464,120 | 0.6% | 93.7% |  |
| _LOAD_CONST_INLINE_BORROW | 7,464,080 | 0.6% | 94.3% |  |
| _GUARD_NOT_EXHAUSTED_TUPLE | 4,478,580 | 0.4% | 94.7% | 16.7% |
| _ITER_CHECK_TUPLE | 4,478,580 | 0.4% | 95.0% |  |
| _GUARD_NOT_EXHAUSTED_LIST | 4,478,560 | 0.4% | 95.4% | 16.7% |
| _ITER_CHECK_LIST | 4,478,560 | 0.4% | 95.8% |  |
| CONTAINS_OP | 3,732,120 | 0.3% | 96.1% |  |
| _ITER_NEXT_LIST | 3,732,120 | 0.3% | 96.4% |  |
| _ITER_NEXT_TUPLE | 3,732,120 | 0.3% | 96.7% |  |
| _LOAD_CONST_INLINE_WITH_NULL | 3,732,120 | 0.3% | 97.0% |  |
| BINARY_SUBSCR_LIST_INT | 3,732,080 | 0.3% | 97.3% |  |
| COMPARE_OP_FLOAT | 3,732,080 | 0.3% | 97.6% |  |
| POP_TOP | 3,732,000 | 0.3% | 97.9% |  |
| CALL_BUILTIN_O | 3,732,000 | 0.3% | 98.2% |  |
| CALL_METHOD_DESCRIPTOR_O | 3,732,000 | 0.3% | 98.5% |  |
